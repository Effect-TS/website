...
- [Kit Langton][Kit] works at Anomaly. He brought Astra and the "free" tokens.
- [Tim Smart][Tim] runs The Boys, our AI agents for investigating and revising PRs.
- [Sebastian Lorenz][Sebastian] encouraged the PR flood and helped rescue CI.
- [Giulio Canti][Giulio] handled schema fixes and replacement implementations.
- [Aiden Cline][Aiden] found the loophole in the PR limit. Our defense counsel.
- [Maxwell Brown][Maxwell] supplied the memes and reviewed this post.
- [dax] wanted to know who was paying.
- [Mirela Prifti][Mirela] helped us tell the story.
- [Michael Arnaldi][Michael]. That's me. I encouraged this.
...
[Michael]: https://x.com/MichaelArnaldi

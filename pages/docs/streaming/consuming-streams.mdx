...
```ts file=<rootDir>/src/streaming/consuming-streams/runCollect.ts
...
```ts file=<rootDir>/src/streaming/consuming-streams/runForEach.ts
...
```ts file=<rootDir>/src/streaming/consuming-streams/fold.ts
...
```ts file=<rootDir>/src/streaming/consuming-streams/Sink.ts

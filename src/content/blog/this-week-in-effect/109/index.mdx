---
pagefind: false
title: "This Week in Effect - #109"
excerpt: T3Code adopts Effect, ThePrimeagen gives it a try, and Trellis AI is hiring an Effect engineer. Plus STM-focused Office Hours and more Effect v4 Beta updates.
date: 2026-03-13
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- [t3-code](https://github.com/pingdotgg/t3code) is built with Effect 🔥.

&nbsp;

- The Effect pill finds everyone eventually.

  <Tweet id="2031885878633648369" />

&nbsp;

- An Effect toolkit for building custom coding agents -- soon by Tim Smart!

  <Tweet id="2032235002675806536" />
...
- [real-world-effect](https://github.com/jeremyosih/real-world-effect) – A collection of open source Effect applications.

&nbsp;

- [effect-htmx](https://github.com/tatemz/effect-htmx) – An Effect-first integration for building HTMX-powered applications. Project by Tate Barber.

&nbsp;

- [effect-atom-jsx](https://github.com/doeixd/effect-atom-jsx#effect-atom-jsx) – A JSX-based approach to building reactive UIs with Effect atoms. Project by Patrick G.

&nbsp;

- [Foldkit UI](https://foldkit.dev/ui/overview) just shipped 14 accessible, unstyled components, making it more practical to build frontend applications where Effect is the foundation. Project by Devin Jameson.

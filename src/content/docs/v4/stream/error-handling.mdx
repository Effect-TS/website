...
There's also a variant called `Stream.orElseEither` that uses the [Result](/docs/data-types/result/) data type to distinguish elements from the two streams based on success or failure:

---
title: Equal
description: The Equal module provides value-based equality checks in TypeScript, supporting custom definitions for predictable behavior and data integrity.
sidebar:
  order: 0
---
...
**Example** (Implementing `Equal` in a Class)

...
- [effect-uai](https://github.com/betalyra/effect-uai) - composable, effectful building blocks for building AI agents with Effect. By betalyra. Check out the project reveal on YouTube.

...
Some examples of such data types include [Option](/docs/data-types/option/), [Either](/docs/data-types/either/), [HashSet](/docs/v3/api/effect/HashSet), and [HashMap](/docs/v3/api/effect/HashMap).

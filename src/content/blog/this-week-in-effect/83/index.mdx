...
excerpt: Effect showcased at the official AWS Developers channel! Complex dependencies now more manageable with Effect Layers. Rewriting Effect's CLI code session.
date: 2025-09-12
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- Maxwell Brown, Effect Core Contributor, presented Effect on the official **AWS Developers** channel. Together with James Ward, Principal Developer Advocate at Amazon, Maxwell showed how to create reliable AI agents using TypeScript, Effect, and Amazon Bedrock, covering error handling, tool integration, schemas, MCP server implementation, and more.
...
- [Foldkit](https://github.com/devinjameson/foldkit), a **lightweight framework for building functional UIs** in TypeScript built with Effect by Devin Jameson.

&nbsp;

- In a recent [post on X](https://x.com/afonsolfm/status/1966052381566881948), Afonso Matos went through the challenges of building their SaaS, [Arvow](https://arvow.com/), and how Effect helped them build more resilient and maintainable software, simplifying error handling, workflows, and stability where everything used to break.

&nbsp;

- Congrats to Marcelo Bairros for presenting [Ledda.ai](https://www.ledda.ai) and never missing the chance to spread the word about Effect!
  <Tweet id="1965767249547182379" />

&nbsp;

- [`@effect-native/crsql`](https://github.com/effect-native/effect-native/tree/effect-native/main/packages-native/crsql), an Effect Service with `@effect/sql` prepared statements for working with the cr-sqlite extension, was released this week by Tom Aylott.

- [`@parischap/conversions`](https://www.npmjs.com/package/@parischap/conversions), [`@parischap/pretty-print`](https://www.npmjs.com/package/@parischap/pretty-print), [`@parischap/ansi-styles`](https://www.npmjs.com/package/@parischap/ansi-styles) by Jérôme Martin.
...
In his latest tutorial, Mattia Manzati shows how Effect Layers make complex dependencies more manageable!

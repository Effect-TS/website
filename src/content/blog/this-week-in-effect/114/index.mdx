---
pagefind: false
title: "This Week in Effect - #114"
excerpt: "Effect just crossed 10m weekly downloads! 🔥  `effect-genserver` by Tim Smart. Effect v4 Beta: Schema refinements & IDB persistence. Intro to STM."
date: 2026-04-17
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- Tim Smart released [effect-genserver](https://github.com/tim-smart/effect-genserver), bringing GenServer-style actor semantics to Effect. Compatible with Effect Cluster, RPC, and Effect Atom.

  <Tweet id="2044208359696674845" />

&nbsp;

- Stay committed to _not_ listening to Mike.

  <Tweet id="2045156760185418046" />

&nbsp;

- Production-grade taste.

  <Tweet id="2044750180084261129" />

&nbsp;

- Micha Hernandez van Leuffen shared how [Fiberplane](https://fiberplane.com/) has been using Claude Code alongside Effect for typed errors and dependency management.

  <Tweet id="2043702882310996112" />

&nbsp;

- We totally agree with Sebastien here! ✌️

  <Tweet id="2043054520620486917" />

&nbsp;

- [svelte-effect-runtime](https://github.com/usebarekey/svelte-effect-runtime) – Effect Runtime integration for Svelte.

&nbsp;

- [kbroom-nvim](https://github.com/ggallovalle/kbroom-nvim/blob/nvim-0.12/lua/my/luarcjson.lua) – A Neovim configuration showcasing Effect-inspired patterns for Lua Language Server setup and IDE support.

&nbsp;

- [effect-encore](https://github.com/cevr/effect-encore) – A TypeScript library for building Encore.ts applications with Effect.

&nbsp;

- [Effect HTTP API Course](https://www.effective.software/courses/effect-http-api) – A newly published course on building HTTP APIs with Effect.

&nbsp;

- [effect-prodigi](https://github.com/mpsuesser/effect-prodigi) – Type-safe TypeScript bindings for the Prodigi print-on-demand REST API, built with Effect. Project by Marc Suesser.

&nbsp;

- [Effect for TypeScript Developers](https://tonytangdev.github.io/effect-for-ts-developers/) – A 33-step learning guide introducing TypeScript developers to Effect, covering type-safe error handling, dependency injection, and composable program design.
...
<YouTube
  id="https://www.youtube.com/embed/F-FkdW3Ujxg?si=EjovdinSuFuQUJpB"
  title="Effect Office Hours 25 🔥"
/>
...
<YouTube
  id="https://www.youtube.com/embed/JG8JRClKGG8?si=kI8F178Y93bOOtGo"
  title="Intro to Software Transactional Memory (STM)"
/>
...
<YouTube
  id="https://www.youtube.com/embed/PxQheh_YO-c?si=zz6yP1ko7hfdclrJ"

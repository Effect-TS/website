---
pagefind: false
title: "Effect v4 Beta: June Recap"
excerpt: "A recap of everything that landed in the Effect v4 beta during June — adaptive rate limiting, Schema performance improvements, OpenTelemetry enhancements, SQL additions, and more."
date: 2026-06-30
authors:
  - davide_scognamiglio
  - mirela_prifti
...
June was another active month for the Effect v4 beta. The work continued across the full breadth of the ecosystem — new capabilities in rate limiting, Schema, SQL, and CLI, alongside a focused sweep of fixes in OpenTelemetry, HTTP, RPC, and core.

Here is everything that landed in [`effect-smol`](https://github.com/Effect-TS/effect-smol) during June.
...
The Effect v4 beta is still moving. If you want to catch up on everything that landed before June, the [February–May recap](https://effect.website/blog/releases/effect/v4-beta-february-may-recap) covers all the major changes since launch organized by topic.

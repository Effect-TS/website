...
excerpt: OpenRouter's co-founder, Louis Vichy, on the Cause & Effect podcast. Building AI applications with Effect & Netlify. Effect Office Hours 8.
date: 2025-11-14
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- [@effect/ai: link to website docs](https://github.com/Effect-TS/effect/pull/5711) (Documentation Update)

### Effect Cluster

- [Optimize Sharding shard release](https://github.com/Effect-TS/effect/pull/5716) (Optimization)
- [Re-use resume parent messages for child workflows](https://github.com/Effect-TS/effect/pull/5719) (Optimization)
- [Support and test against vitess for SqlRunnerStorage](https://github.com/Effect-TS/effect/pull/5726) (Feature)

### Effect Experimental

- [Add persisted RateLimiter to @effect/experimental](https://github.com/Effect-TS/effect/pull/5731) (Feature)

### Effect Opentelemetry

- [Convert bigints to string for otel](https://github.com/Effect-TS/effect/pull/5734) (Refactor )
- [Handle undefined pg client](https://github.com/Effect-TS/effect/pull/5735) (Improvement)

### Effect Platform

- [Fix UrlParams.setAll overwrite semantics](https://github.com/Effect-TS/effect/pull/5728) (Bug Fix)
- [Ensure HttpApiScalar source is tree-shakable](https://github.com/Effect-TS/effect/pull/5737) (Bug Fix)
- [Make http client tests as flaky](https://github.com/Effect-TS/effect/pull/5740) (Improvement)
- [Increase HttpClient test timeouts](https://github.com/Effect-TS/effect/pull/5741) (Improvement)

### Effect SQL

- [Improve pg client error handling](https://github.com/Effect-TS/effect/pull/5717) (Improvement)
- [PgClient: fix regression on undefined config values](https://github.com/Effect-TS/effect/pull/5725) (Bug Fix)
- [Handle undefined pg client](https://github.com/Effect-TS/effect/pull/5735) (Improvement)

### Effect Workflow

- [Add persisted RateLimiter to @effect/experimental](https://github.com/Effect-TS/effect/pull/5731) (Feature)
- [Don't try resume a child workflow if it has a defect](https://github.com/Effect-TS/effect/pull/5742) (Bug Fix)
- [Remove auto-resumption of child workflows](https://github.com/Effect-TS/effect/pull/5744) (Bug Fix)

&nbsp;

## Cause & Effect Podcast | Episode #6

Inside OpenRouter’s Tech Stack and Use of Effect

Louis Vichy, co-founder of [OpenRouter](https://openrouter.ai/), joins Johannes Schickling and Michael Arnaldi to talk about OpenRouter’s TypeScript stack, their internal tooling powered by Effect, and the engineering challenges of scaling an AI platform processing trillions of tokens weekly.
...
- Maxwell Brown joined Sean C Davis to talk about building AI web applications using Effect and Netlify.

  <YouTube
    id="https://www.youtube.com/embed/8KmFwsj9gbI?si=ewfcsiSQzIuS7-9-"
    title="Building AI applications with Effect + Netlify"
  />

&nbsp;

- Pritam Kadam introduced [cliq](https://kpritam.github.io/cliq), a CLI-based AI coding agent that shows how coding agents actually work, from scratch, using Effect for typed effects & composability.

<Tweet id="1988282125582520787" />

&nbsp;

- [marimo](https://github.com/marimo-team/marimo), a reactive Python notebook, went all in on Effect for its upcoming VS Code extension.

&nbsp;

- **How to Do Real-Time UI Updates in React (WS vs SSE)** by [Lucas Patron](https://www.youtube.com/@lucas-patron).

  <YouTube
    id="https://www.youtube.com/embed/jdJHt2Mbuac?si=7GoVFxbilimM0YKN"
    title="How to Do Real-Time UI Updates in React (WS vs SSE)"
  />

&nbsp;

- Dillon Mulroy livestreamed four new episodes of [**Building a family recipe app with LiveStore, Effect, and CF Workers**](https://www.twitch.tv/videos/2614670954?filter=archives&sort=time).

&nbsp;

- Another coding session by teej dv as he works on [rebuilding terminal.shop using Effect](https://x.com/teej_dv/status/1988271005299605832?s=20).

&nbsp;

## Effect Content Update

- The eighth episode of **Effect Office Hours** went live on Wednesday! We will publish an edited version on our YouTube channel soon. In the meantime, you can watch the livestream on X(Twitter) below.
  <Tweet id="1988623057288892895" />

&nbsp;

- **🔥 Office Hours 7: Scheduling, Context, Layers, Dependency Management, Tooling, Workflows...** is now on our YouTube Channel.

<YouTube
  id="https://www.youtube.com/embed/rXqkuu4D7fQ?si=kaX4mAcBN2SUlbeb"
  title="Office Hours 7: Scheduling, Context, Layers, Dependency Management, Tooling, Workflows..."
/>

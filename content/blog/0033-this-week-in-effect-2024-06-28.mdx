...
It has been a week full of events for our community:
+ [Michael Arnaldi](https://x.com/MichaelArnaldi) participated in a live coding session at [London Node.js User Group](https://x.com/LNUGorg), hosted at the Cloudflare studios, showing how to develop a Dad Jokes API using Effect. Rumor has it that he has been spending much time with [Maxwell Brown](https://x.com/imax153) lately👀
<Tweet id="1806034606338052317" />

+ The second [Effect Paris Meetup](https://www.meetup.com/effect-paris/#), organized by the [Evryg](https://www.evryg.com) team, was a success with a large turnout and excellent feedback. We are thrilled to see our French-speaking community so active and look forward to hearing when the third meetup will take place.

![Paris Meetup Photo](https://media.discordapp.net/attachments/1255093737948844102/1255781410925449286/20240625_193839.jpg?ex=667fb293&is=667e6113&hm=f7b62ff2eba34334bce3118065adedeeac96fc5d331d723f8d613c479b06a1a5&=&format=webp&width=895&height=671)

+ [Milad Vafaeifard](https://x.com/miladvafaeifard), Software Engineer, Effect Advocate, and Creator of [Sign Language Tech](https://www.youtube.com/channel/UCIPaBhc8mQHrt6o0OTuCUXQ) gave a talk about Effect at [JSConf Budapest](https://jsconfbp.com/) and announced that he will post the video on his YouTube channel. We can't wait to see it!
<Tweet id="1806609820801249504" />

+ [Sandro Maglione](https://x.com/SandroMaglione) reminds us of one of the main advantages of using Effect: fewer installed packages mean less complexity and fewer dependencies to maintain.
<Tweet id="1804789139268616482" />

+ [JSNation](https://x.com/thejsnation) published this post with all Open Source Awards Winners. We want to thank the organization again for allowing us to run for this unexpected award, and, most importantly, our entire community for supporting us and helping us achieve our first official recognition.
<Tweet id="1805561129915060248" />

### Content update

+ Effect Days Conference closing keynote has been released on Monday. 'Effect: The Origin Story' by [Michael Arnaldi](https://x.com/MichaelArnaldi). In his talk Michael reflects on the journey of creating the open-source library, Effect, and the vibrant community that has formed around it. Developed using TypeScript and functional programming concepts, Effect has thrived thanks to the community's organic growth and contributions.

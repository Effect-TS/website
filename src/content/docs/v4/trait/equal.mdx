...
```ts twoslash collapse={3-26} import.meta.vitest name="implementing-the-equal-interface-2"
import { Equal, Hash } from "effect"
...
```ts twoslash import.meta.vitest name="simplifying-equality-with-the-data-module-1"
import { Equal } from "effect"

const alice = { id: 1, name: "Alice", age: 30 }

const bob = { id: 2, name: "Bob", age: 40 }

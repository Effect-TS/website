...
- **Embeddings** – vector representations of text for search or retrieval
...
### [`@effect/ai`](https://effect-ts.github.io/effect/docs/ai/ai)
...
### [`@effect/ai-openai`](https://effect-ts.github.io/effect/docs/ai/openai)

Concrete implementations of services from `@effect/ai` backed by the [OpenAI API](https://platform.openai.com). 

Supported services include:
- `Completions` (via OpenAI's [Chat Completions API](https://platform.openai.com/docs/api-reference/chat))
- `Embeddings` (via OpenAI's [Embeddings API](https://platform.openai.com/docs/api-reference/embeddings))

### [`@effect/ai-anthropic`](https://effect-ts.github.io/effect/docs/ai/anthropic)
...
Supported services include:
- `Completions` (via Anthropic's [Messages API](https://docs.anthropic.com/en/api/messages))

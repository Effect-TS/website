...
<Aside type="tip">
  ...
  types](/docs/v3/schema/advanced-usage/#branded-types).
</Aside>
...
<Aside type="tip" title="Effectful Filters">
  ...
  [Schema.filterEffect](/docs/v3/schema/transformations/#effectful-filters).
</Aside>
...
<Aside type="tip" title="Using ArrayFormatter for Structured Errors">
  ...
  [ArrayFormatter](/docs/v3/schema/error-formatters/#arrayformatter).
</Aside>
...
Here is a list of useful [Duration](/docs/v3/data-types/duration/) filters provided by the Schema module:

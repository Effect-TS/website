...
excerpt: "Effect v4 RC's core package reaches zero external dependencies, with a native PostgreSQL protocol client and reworked native Schema Arbitraries. WebSocket client support lands across Node, Bun, Deno, and the browser."
date: 2026-08-28
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- It looks like our core package reaching 0 external dependency is making some waves 💯.

  <Tweet id="2092435159396254115" />

  <Tweet id="2092441062170079450" />

  <Tweet id="2092454006467797252" />

- Yep, now you have no more excuses!
...
- "Till the day where the regular api will just be Effect" (cit. Michael Arnaldi).

  <Tweet id="2092006419562115463" />

- [Josh Pitzalis](https://www.jxsh.io/) is rewriting all the Python exercises in Anthropic's Claude certification program in Effect. Check out his [blog](https://www.jxsh.io/blog/) to stay updated to the latest excercises added. New this week: **Temperature with Effect**, **Response Streaming with Effect** and **Structured Data with Effect**.
...
- [effect-mq](https://github.com/TeamWarp/effect-mq) - Effect-native background jobs, with schema-first job definitions, a storage-agnostic queue core, a worker runtime, and a Postgres store. By Warp.

...
```ts filename="resource.ts" file=<rootDir>/src/tutorial/resource-management/scope/resource.ts
...
```ts file=<rootDir>/src/tutorial/resource-management/scope/using-pipe.ts
...
```ts file=<rootDir>/src/tutorial/resource-management/scope/using-gen.ts
...
```ts /Effect.scoped/ file=<rootDir>/src/tutorial/resource-management/scope/scoped-pipe.ts
...
```ts /Effect.scoped/ file=<rootDir>/src/tutorial/resource-management/scope/scoped-gen.ts
...
```ts file=<rootDir>/src/tutorial/resource-management/scope/acquireUseRelease.ts

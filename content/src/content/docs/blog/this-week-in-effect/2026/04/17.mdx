---
pagefind: false
title: This Week in Effect - 2026-04-17
excerpt: "`effect-genserver` by Tim Smart. Fiberplane on using Effect with Claude Code. Effect v4 Beta: Schema refinements & IDB persistence. Office Hours 25, Intro to STM, and new community projects."
date: 2026-04-17
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- Micha Hernandez van Leuffen shared how [Fiberplane](https://fiberplane.com/) has been using Claude Code alongside Effect for typed errors and dependency management, writing up their full setup, rules, and learnings.

  <Tweet id="2043702882310996112" />

&nbsp;

- Sebastien praised [effect.institute](https://www.effect.institute/) as a great resource and another reason to learn Effect.

  <Tweet id="2043054520620486917" />

&nbsp;

- [svelte-effect-runtime](https://github.com/usebarekey/svelte-effect-runtime) – Effect Runtime integration for Svelte, bringing Effect framework capabilities to Svelte applications.
...
- [effect-encore](https://github.com/cevr/effect-encore) – A TypeScript library for building Encore.ts applications with Effect, providing a type-safe integration between the two frameworks.

&nbsp;

- [Effect HTTP API Course](https://www.effective.software/courses/effect-http-api) – A newly published course on building HTTP APIs with Effect, available on effective.software.

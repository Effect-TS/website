...
| [Socket](/docs/v4/api/effect/unstable/socket/Socket)                                               | A module for socket-based communication.        | <Badge text="Unstable" variant="caution" /> |
| [Worker](/docs/v4/api/effect/unstable/workers/Worker)                                              | A module for running tasks in separate workers. | <Badge text="Unstable" variant="caution" /> |

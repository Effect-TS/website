...
If you don't want to stop on an error, you can use the `Effect.either` method to encapsulate the error in the [Either](/docs/v3/api/effect/Either) data type: see the [examples of managing expected errors](/docs/v3/error-management/expected-errors/#either).

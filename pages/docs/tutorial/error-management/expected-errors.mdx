...
```ts file=<rootDir>/src/tutorial/error-management/expected-errors/fail.ts
...
```ts /_tag/ file=<rootDir>/src/tutorial/error-management/expected-errors/fail.ts#L3-L5
...
```ts filename="error-accumulation-pipe.ts" file=<rootDir>/src/tutorial/error-management/expected-errors/error-accumulation-pipe.ts#L1-L26
...
```ts filename="error-accumulation-gen.ts" file=<rootDir>/src/tutorial/error-management/expected-errors/error-accumulation-gen.ts#L1-L27
...
```ts {6} file=<rootDir>/src/tutorial/error-management/expected-errors/catchAll-pipe.ts
...
```ts {7-10} file=<rootDir>/src/tutorial/error-management/expected-errors/catchAll-gen.ts
...
```ts {6-8} file=<rootDir>/src/tutorial/error-management/expected-errors/catchTag-pipe.ts
...
```ts {9-11} file=<rootDir>/src/tutorial/error-management/expected-errors/catchTag-gen.ts
...
```ts {9-11} file=<rootDir>/src/tutorial/error-management/expected-errors/catchTag-pipe-2.ts
...
```ts {12} file=<rootDir>/src/tutorial/error-management/expected-errors/catchTag-gen-2.ts
...
```ts {6-9} file=<rootDir>/src/tutorial/error-management/expected-errors/catchTags-pipe.ts
...
```ts {9-14} file=<rootDir>/src/tutorial/error-management/expected-errors/catchTags-gen.ts
...
```ts {6-12} file=<rootDir>/src/tutorial/error-management/expected-errors/mapError-pipe.ts
...
```ts {9-14} file=<rootDir>/src/tutorial/error-management/expected-errors/mapError-gen.ts
...
```ts file=<rootDir>/src/tutorial/error-management/expected-errors/short-circuiting-pipe.ts
...
```ts file=<rootDir>/src/tutorial/error-management/expected-errors/short-circuiting-gen.ts

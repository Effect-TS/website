...
excerpt: "Ziverge becomes the first official Effect Adoption Partner. Talks from Effect Miami 2 on Effective State Machines, NestJS migration, and agentic runtimes."
date: 2026-07-31
authors:
  - davide_scognamiglio
  - mirela_prifti
...
A landmark week for the v4 beta, with native Deno support landing in full, a broad security hardening sweep, as well as deep fiber runtime fixes.
...
- [Fix(effect): TMap.remove/removeAll clears entire bucket on hash collision](https://github.com/Effect-TS/effect/pull/6233) (Bug Fix)
...
We're thrilled to announce [Ziverge](https://www.ziverge.com/) as the first [Effect Adoption Partner](https://www.effect.website/adoption-partners/ziverge), and they've also launched an Effect Training Workshop.
...
- Try [effect-atom](https://github.com/tim-smart/effect-atom)

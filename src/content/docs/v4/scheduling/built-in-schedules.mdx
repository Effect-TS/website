...
```ts twoslash import.meta.vitest name="built-in-schedules-1"
import { Array, Duration, Effect, Pull, Schedule } from "effect"

const log = (schedule: Schedule.Schedule<unknown>, delay: Duration.Input = 0): void => {
...
```ts twoslash collapse={3-33} import.meta.vitest name="forever-1"
import { Array, Duration, Effect, Pull, Schedule } from "effect"
...
```ts twoslash collapse={3-33} import.meta.vitest name="once-1"
import { Array, Duration, Effect, Pull, Schedule } from "effect"
...
```ts twoslash collapse={3-33} import.meta.vitest name="recurs-1"
import { Array, Duration, Effect, Pull, Schedule } from "effect"
...
```ts twoslash collapse={3-33} import.meta.vitest name="spaced-1"
import { Array, Duration, Effect, Pull, Schedule } from "effect"
...
```ts twoslash collapse={3-33} import.meta.vitest name="fixed-1"
import { Array, Duration, Effect, Pull, Schedule } from "effect"
...
```ts twoslash collapse={3-33} import.meta.vitest name="exponential-1"
import { Array, Duration, Effect, Pull, Schedule } from "effect"
...
```ts twoslash collapse={3-33} import.meta.vitest name="fibonacci-1"
import { Array, Duration, Effect, Pull, Schedule } from "effect"

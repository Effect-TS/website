...
The same app was used in the [Advanced Workshop](https://github.com/IMax153/advanced-effect-workshop) held in Vienna by [Maxwell Brown](https://x.com/maxwellbrown), you can start to follow the workshop from the material knowing that recordings will be made public soon, together with the [Beginner/Intermediate Workshop](https://github.com/ethanniser/effect-workshop) held by [Ethan Niser](https://twitter.com/ethanniser).

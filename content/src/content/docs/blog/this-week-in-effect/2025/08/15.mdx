...
excerpt: Claude Code from scratch with Effect, by Kit Langton. Amazon Bedrock AI provider integration & Implementing a feature or Effect Workflows code sessions and more.
date: 2025-08-15
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- Three more videos from the **Build an App with Effect** series by Lucas Barake.
...
- **spring.new**, Anthropic's flagship costumer, is hiring 10x engineers experienced with Effect. See the job posting in the `#job-board` channel on [our Discord](https://discord.com/channels/795981131316985866/796153351372275743/1405134163287343196).

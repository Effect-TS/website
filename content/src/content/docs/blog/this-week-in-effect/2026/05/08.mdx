---
pagefind: false
title: This Week in Effect - 2026-05-08
excerpt: "Effect Miami Meetup announced! HttpApiTest & acquireDisposable in v4 Beta. sqlfu gets @effect/sql support. Fiberplane builds agentic guardrails with Effect traces."
date: 2026-05-08
authors:
  - davide_scognamiglio
  - mirela_prifti
...
### Effect Cluster
- [EFF-788: Support null K8s lastTransitionTime values](https://github.com/Effect-TS/effect/pull/6217) (Feature)

&nbsp;

## Community Events

We're excited to announce that the first [Effect Miami Meetup](https://luma.com/eyp4vnq5) is happening on May 28 at [The LAB Miami](https://www.google.com/maps/search/?api=1&query=25.802390799999998%2C-80.20211379999999&query_place_id=ChIJ72xHpLO22YgR6Smzf_IA8OU).

  <Tweet id="2052029844087513179" />
...
A reminder of the upcoming [Effect Vienna Meetup #2](https://luma.com/c49s62t2) on May 27, sponsored by [Sentry](https://sentry.io/welcome/).
  ...
  <Tweet id="2051645514626605163" />

We just announced the main talk of the event: **​Observability with Effect + Sentry by Jan Peer Stöcklmair**
...
- `@effect/sql` support is coming to sqlfu — write your data layer in plain SQL with Effect's DI system and generator syntax. 🔥

  <Tweet id="2051620858888589344" />

&nbsp;

- Looking for large open-source Effect codebases with established patterns to learn from?

  <Tweet id="2052082752883921282" />

&nbsp;

- The urge is real. 😄

  <Tweet id="2052069349331214486" />
...
- [pi-effect-harness](https://github.com/mpsuesser/pi-effect-harness) - a Pi extension that enforces Effect v4 best practices during agent-assisted coding sessions, gating writes until key Effect skills are loaded and providing real-time pattern feedback to prevent common mistakes and deprecated patterns.

&nbsp;

- [@nmnmcc/ability](https://github.com/nmnmcc/ability) - an authorization library bringing Effect-style programming to permission checking, backed by CASL's rule engine. It provides immutable rule sets, Mongo-style conditions, and field-level access control with typed errors.

&nbsp;

- [effect-uai](https://effect-uai.betalyra.com) - effectful building blocks for agentic AI by [Betalyra](https://betalyra.com), offering streaming-first architecture and composable primitives for constructing agent loops with explicit control, typed effects, retries, and concurrency.

&nbsp;

- [s20-wifi-setup](https://github.com/kachkaev/s20-wifi-setup) - a TypeScript command-line tool for connecting legacy Orvibo WiWo S20 smart sockets to Wi-Fi networks by recreating the original pairing flow, built with Effect.

&nbsp;

- [@siebix/cloudflare-browser-run-effect](https://github.com/siebix-studio/effect-reusables/tree/main/packages/cloudflare-browser-run-effect) - an Effect service library providing typed schemas and utilities for Cloudflare Browser Run Quick Actions, enabling browser automation tasks like screenshots, link extraction, and page crawling through Effect's functional programming patterns.
...
- What is Alchemy? Zero-to-Production Infrastructure in TypeScript & Effect | Office Hours 27
 ...
 <YouTube
  id="https://www.youtube.com/embed/EMbztKSI3-o?si=P3W4TlPrQmtqT-Rc"
  title="What is Alchemy? Zero-to-Production Infrastructure in TypeScript & Effect | Office Hours 27"
/>
...
- DrainableWorker
 ...
 <YouTube
  id="https://www.youtube.com/embed/41bNtyz4NZE?si=XRFV2JD6t5o7n4vw"
  title="DrainableWorker"
/>

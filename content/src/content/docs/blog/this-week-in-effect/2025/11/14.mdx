...
excerpt: Cause & Effect podcast episode with OpenRouter. Building AI applications with Effect & Netlify. Effect Office Hours 8.
date: 2025-11-14
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- Maxwell Brown joined Sean C Davis to explore integrating AI into web applications using Effect and [Netlify](https://www.netlify.com).
...
- [marimo](https://github.com/marimo-team/marimo), a reactive Python notebook, went all in on Effect for its upcoming [VS Code extension](https://github.com/marimo-team/marimo-lsp/tree/main/extension).

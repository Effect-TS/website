...
excerpt: Effect v4 Beta release! 🚀 Rewritten runtime. Smaller bundles. Unified package system.
date: 2026-02-20
authors:
  - davide_scognamiglio
  - mirela_prifti
...
[Watch the full breakdown](https://www.youtube.com/watch?v=P04R7lUR4Cc) by Maxwell Brown and Mattia Manzati.
...
- [Fix(ai-openrouter): optional name in streaming tool calls](https://github.com/Effect-TS/effect/pull/6071) (Bug Fix)
...
<Tweet id="2024516494898667754" />

&nbsp;

<Tweet id="2024254968140562466" />

&nbsp;

- [Ryan Vogel](https://x.com/ryanvogel) pledged to read the Effect docs if his post reached 500 likes. Well... let's say the community never disappoints.

<Tweet id="2023143450435338653" />

&nbsp;

- [`confect`](https://github.com/rjdellecese/confect) - Confect v1 is live! Confect is a framework that deeply integrates Effect with Convex to define database schemas using Effect schemas, write validators, and access Convex capabilities through Effect services. Project by [rjdellecese](https://github.com/rjdellecese).

&nbsp;

- [`effective-progress`](https://github.com/stromseng/effective-progress) - An Effect native CLI progress bar library. Project by [stromseng](https://github.com/stromseng).

&nbsp;

- [`jazz`](https://github.com/lvndry/jazz) - A CLI that lets you create autonomous AI agents with real-world capabilities, built with Effect. Project by [lvndry](https://github.com/lvndry).

&nbsp;

- [EffectTalk](https://effecttalk.dev/) - Effect production-ready patterns, curated by Paul Philip.

&nbsp;

- [Effective Software courses](https://www.effective.software/courses) - Free resources on Effect Atom & Effect HttpClient. By [Hemanta Kumar Sundaray](https://www.effective.software/).
...
<YouTube
  id="https://www.youtube.com/embed/apklpPEgZgw?si=dtWeRw9E3RuF36g0"

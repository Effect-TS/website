...
Plain objects implement [`Equal`](/docs/v4/trait/equal/) automatically, based on structural equality — no wrapper needed. Values decoded with `Schema` already benefit from this, as shown below.

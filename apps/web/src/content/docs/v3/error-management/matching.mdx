...
In the Effect module, similar to other modules like [Option](/docs/v3/data-types/option/#pattern-matching) and [Exit](/docs/v3/data-types/exit/#pattern-matching), we have a `Effect.match` function that allows us to handle different cases simultaneously.
...
the full [cause](/docs/v3/data-types/cause/) of the failure within a fiber.
...
This function provides access to the complete [cause](/docs/v3/data-types/cause/) of the

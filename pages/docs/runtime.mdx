...
```ts file=<rootDir>/src/runtime/defaultRuntime.ts
...
```ts file=<rootDir>/src/runtime/addSimpleLogger.ts
...
```ts file=<rootDir>/src/runtime/addSimpleLogger-region.ts
...
```ts file=<rootDir>/src/runtime/toRuntime.ts

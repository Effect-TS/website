...
```ts filename="error-accumulation.ts" file=<rootDir>/src/tutorial/error-management/expected-errors/error-accumulation.ts#L1-L26
...
```ts filename="error-accumulation.ts" file=<rootDir>/src/tutorial/error-management/expected-errors/error-accumulation-gen.ts#L1-L27

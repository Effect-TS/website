...
Welcome to another month of Effect v4 beta, which gained native Deno support, a Schedule overhaul, a new Graph module, and a series of correctness fixes. `effect-smol` was merged into `Effect-TS/effect`, and `main` is now officially Effect v4.

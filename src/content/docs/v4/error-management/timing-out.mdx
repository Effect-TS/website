...
exit // => Exit.fail(new Cause.TimeoutError())
```
...
const result = await Effect.runPromise(timedOutEffect)
console.log(result)
/*
Output:
Start processing...
...
exit // => Exit.fail(new MyTimeoutError())
```

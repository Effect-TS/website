...
Effect has always been tree-shakeable, and in v4, many core modules have been rewritten from the ground up to be smaller and more efficient. A minimal program using Effect, Stream, and Schema drops from roughly 70 kB in v3 to about 20 kB in v4 — and individual use cases scale accordingly.

Whether you're pulling in just the core, adding streams, or using schema, the size of your Effect v4 applications should be significantly smaller than with Effect v3.

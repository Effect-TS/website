...
excerpt: Visual Effect is now open-source! Effect Milan Meetup 🇮🇹. Effect Office Hours 4. Twitch–Spotify Integration and Effect AI SDK Refactor coding sessions.
date: 2025-10-17
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- [Use external interruption for workflow suspend](https://github.com/Effect-TS/effect/pull/5640) (Improvement)
- [Fix ReferenceError in NodeSocket.fromNet](https://github.com/Effect-TS/effect/pull/5642) (Bug Fix)
...
- More teams are bringing Effect into their codebases. This week, we learned about **Notion** and **Supermemory** joined the list!

  <Tweet id="1977854423658283220" />

  <Tweet id="1978553760352792791" />
...
- [Visual Effect](https://github.com/kitlangton/visual-effect) by Kit Langton, an interactive visualizer for Effect programs, is now open source and built with Effect!

  <Tweet id="1976804739208953917" />

&nbsp;

- We had a blast on Thursday, Oct 16, at the Effect Meetup in Milan 🇮🇹. Huge thanks to Davide Di Pumpo & Prima for organizing and hosting the event – and to our speakers Mattia Manzati & Mattia Crovero for their great talks!

  <Tweet id="1978870735431954700" />

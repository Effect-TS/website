...
- Kit Langton, [@kitlangton](https://x.com/kitlangton), works at Anomaly. He brought Astra and the "free" tokens.
- Tim Smart, [@tim_smart](https://x.com/tim_smart), runs The Boys, our AI agents for investigating and revising PRs.
- Sebastian Lorenz, [@thefubhy](https://x.com/thefubhy), encouraged the PR flood and helped rescue CI.
- Giulio Canti, [@GiulioCanti](https://x.com/GiulioCanti), handled schema fixes and replacement implementations.
- Aiden Cline, [@rekram11](https://x.com/rekram11), found the loophole in the PR limit. Our defense counsel.
- Maxwell Brown, [@imax153](https://x.com/imax153), supplied the memes and reviewed this post.
- dax, [@thdxr](https://x.com/thdxr), wanted to know who was paying.
- Mirela Prifti, [@MirelaPriftix](https://x.com/MirelaPriftix), helped us tell the story.
- Michael Arnaldi, [@MichaelArnaldi](https://x.com/MichaelArnaldi). That's me. I encouraged this.
...
**Kit Langton**, thank you for orchestrating the whole thing, sending us the findings, and giving us several days of material for this post. An unreasonable number of agents turned out to be a productive use of the token budget. We'll let you and dax settle the accounting.

**Tim Smart and The Boys**, thank you for working through the queue. Tim's AI infrastructure, built with **[Multica](https://multica.ai/)**, gave us a way to get the investigations and revisions done while keeping the final feedback with the humans. Also, condolences to Tim's shift-clicking hand.

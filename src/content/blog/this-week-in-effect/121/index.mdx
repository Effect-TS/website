...
- [Emit additionalProperties: false for records with string keys and Schema.Never values](https://github.com/Effect-TS/effect/pull/6257) (Bug Fix)
- [Fix(Data): preserve generic A in TaggedEnum $match arms](https://github.com/Effect-TS/effect/pull/6250) (Bug Fix)

### Effect AI

- [Fix(ai): support empty tool parameters](https://github.com/Effect-TS/effect/pull/6260) (Bug Fix)
...
- _Effect: Make code easier for AI to write, not for you._.

...
const schedule = Schedule.min([Schedule.exponential("100 millis"), Schedule.spaced("1 second")])
...
const schedule = Schedule.max([Schedule.exponential("10 millis"), Schedule.recurs(5)])
...
const schedule = Schedule.concat(Schedule.recurs(5), Schedule.spaced("1 second"))
...
const schedule = Schedule.modifyDelay(Schedule.spaced("1 second"), ({ output, duration }) =>

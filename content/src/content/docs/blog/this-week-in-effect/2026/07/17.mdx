...
excerpt: "effect-smol is archived and merged into Effect-TS/effect - main is now officially v4! Plus new community projects: Crosshatch, Kit Langton's Skills, svelte-effect-runtime v4, and Effect Commander."
date: 2026-07-17
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- A big thank you to all the attendees, the speakers, and the organizers of **Effect Miami 🇺🇸 #2 Meetup**.
...
- Got it, [Tibo](https://x.com/thsottiaux)?
...
- Community-created resources are constantly evolving. Follow us on social media and join our [Discord](https://discord.gg/effect-ts) server to stay up to date.

  <Tweet id="2077710307800088812" />

&nbsp;

- [Crosshatch](https://github.com/crosshatch/crosshatch) – an Effect-native toolkit for composing x402 payments, enabling accountless payments across EVM and Solana with USD-denominated stablecoins.

&nbsp;

- [Skills](https://github.com/kitlangton/skills) – a collection of reusable skills, including one for writing production TypeScript with Effect v4. Project by Kit Langton.

&nbsp;

- [svelte-effect-runtime](https://github.com/usebarekey/svelte-effect-runtime) – a Vite plugin and language server that lets Svelte developers write effectful code directly in component scripts, using `yield*` to handle async operations and side effects. Just hit its v4 release.

...
excerpt: "Effect v4 Beta: OTLP observability, Schema & HTTP updates. Dax Raad at OpenCode 🎙. effect-language-service-tsgo on Zed 🧩."
date: 2026-06-05
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- 📈
  ...
  <Tweet id="2061847010370531341" />
  <Tweet id="2061543450768486735" />

&nbsp;

- We can't recommend [effect.institute](https://www.effect.institute/) enough!

  <Tweet id="2060886001380118892" />
...
- **Effect: Make code easier for AI to write, not for you.** by Steve Kwok.

  <Tweet id="2061777737388532010" />

&nbsp;

- That's the best thing about Effect!

  <Tweet id="2061895838318666060" />

&nbsp;

- Zack spreading wisdom ✅

  <Tweet id="2060782176661053737" />

&nbsp;

- We can't wait for it, Nathan. Check the code review in the **Effect Office Hours 31 🔥** livestream below.
...
- [effect-language-service-tsgo](https://zed.dev/extensions/effect-language-service-tsgo) - the Effect Language Service extension for Zed is finally searchable and installable via the Zed extension page.
...
- Here's a version with the screenshare made by [Ben Jacobson](https://x.com/bjacobso).

...
Sequential combinators such as [Effect.zip](/docs/v3/code-style/control-flow/#zip), [Effect.all](/docs/v3/code-style/control-flow/#all) and [Effect.forEach](/docs/v3/code-style/control-flow/#foreach) have a "fail fast" policy when it comes to error management. This means that they stop and return immediately when they encounter the first error.

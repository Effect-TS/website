...
Some examples of such data types include [Option](/docs/data-types/option/), [Result](/docs/data-types/result/), [HashSet](/docs/v4/api/effect/HashSet), and [HashMap](/docs/v4/api/effect/HashMap).

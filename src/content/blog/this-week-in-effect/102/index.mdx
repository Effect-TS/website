...
excerpt: 13k 🌟! I wish I learned Effect sooner, the secret to production-grade Typescript. RcMap | Effect in 5(ish). Hacking on Lalph & Effect Office Hours coding sessions.
date: 2026-01-23
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- [Fix Config.orElseIf signature](https://github.com/Effect-TS/effect/pull/5970) (Bug Fix)
- [Fix Array.flatten type inference loss](https://github.com/Effect-TS/effect/pull/5981) (Bug Fix)
- [Fix prototype comparison in Equal.ts](https://github.com/Effect-TS/effect/pull/5996) (Bug Fix)

### Effect Opentelemetry

- [Fix(opentelemetry): correct Span.addEvent 2-arg overload](https://github.com/Effect-TS/effect/pull/5929) (Bug Fix)
- [Feat(opentelemetry): add protobuf protocol support for OTLP exporters](https://github.com/Effect-TS/effect/pull/5927) (Feature)
- [Fix(opentelemetry): make sdk-trace-node and sdk-trace-web required peer deps](https://github.com/Effect-TS/effect/pull/5952) (Bug Fix)

### Effect Platform

- [Add rows and isTTY to Terminal](https://github.com/Effect-TS/effect/pull/5977) (Features)

&nbsp;

## Community Events

Don't miss our upcoming [Effect Berlin Meetup #2 🇩🇪](https://luma.com/effect-community?e=calev-yq3Meujax7IFE8j) on January 29, and the newly announced [Effect Paris Meetup #6 🇫🇷](https://www.meetup.com/fr-fr/effect-paris/events/312953757/) on February 3.
...
<YouTube
  id="https://www.youtube.com/embed/85yz418Tris?si=8Wm6269_sjUQDclE"
  title="I wish I learned Effect sooner: The secret to production-grade Typescript"
/>

&nbsp;

- **RcMap | Effect in 5(ish)** by Lucas Barake.

<YouTube
  id="https://www.youtube.com/embed/JGcZTqjDZPk?si=2CKWD5ej4E-B3OeC"
  title="RcMap | Effect in 5(ish)"
/>

&nbsp;

- [`better-pdf-reader`](https://github.com/BLANKSPACETS/better-pdf-reader) - An open-source PDF and EPUB reader for developers featuring a command palette, reading timer, AI-friendly Markdown export, and OLAP analytics. Built with Effect, Next.js, and PDF.js with a local-first architecture. Project by [BLANKSPACETS](https://github.com/BLANKSPACETS).

&nbsp;

- [`odata-effect`](https://github.com/joepjoosten/odata-effect) - A fully tree-shakable OData V2/V4 client for SAP services built on Effect, featuring type-safe query building, batch requests, and SAP-specific error handling. Project by [joepjoosten](https://github.com/joepjoosten).

&nbsp;

- [Effect TS: The New Standard for Building Production APIs](https://blog.type-driven.com/effect-ts-new-standard/) - A blog post by [Type Driven](https://blog.type-driven.com) exploring why Effect is becoming the preferred choice for production APIs, highlighting typed errors, built-in reliability features, dependency injection, and integrated observability.

&nbsp;

- [Building a Fault-Tolerant Web Data Ingestion Pipeline with Effect-TS](https://javascript.plainenglish.io/building-a-fault-tolerant-web-data-ingestion-pipeline-with-effect-ts-0bc5494282ba) - A practical guide on building predictable, fault-tolerant web data ingestion systems using typed errors, safe resource management, declarative retry logic, and composable pipelines.
...
<YouTube
  id="https://www.youtube.com/embed/wYddFSTHo5E?si=mWDxtWFLMhJFMz8v"
  title="Hacking on Lalph - A Ralph-inspired AI agent orchestrator powered by Effect"
/>

&nbsp;

<YouTube
  id="https://www.youtube.com/embed/cVExYNB-dxc?si=Fm_4__Mh9SeqqfFD"
  title="Office Hours 12: Library Design, Error Modeling, Schema vs runtime errors, Effect 4.0 APIs"
/>

&nbsp;

- [Effect Office Hours 13](https://x.com/EffectTS_/status/2013990786116046954) went live on Wednesday on X(Twitter)! The edited version will be on our YouTube channel soon.

&nbsp;

- Max joined Tim to continue the work on _Lalph - An AI Agent Orchestrator_.
  <Tweet id="2014102979897598233" />

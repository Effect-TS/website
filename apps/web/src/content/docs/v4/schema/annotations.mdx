...
| `arbitraryConstraint`  | check           | Guides native [Arbitrary](/docs/v4/schema/arbitrary) generation for a custom filter.                   |
| `toCodecArbitrary`     | declaration     | Defines a generatable representation for a custom declaration.                                         |

...
- [HashSet](/docs/v3/api/effect/HashSet) - Immutable
- [MutableHashSet](/docs/v3/api/effect/MutableHashSet) - Mutable
...
Effect's [`Data`](/docs/v3/api/effect/Data) and [`Schema.Data`](/docs/v3/schema/effect-data-types/#interop-with-data) modules implement `Equal` for you automatically, based on structural equality.

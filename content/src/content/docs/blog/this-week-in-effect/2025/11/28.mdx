...
excerpt: Effect Solutions and `doctor-effect` by Kit Langton.
date: 2025-11-28
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- Effect mentioned in the **SPECIAL THANKSGIVING EPISODE - The Standup** by [ThePrimeagen](https://x.com/ThePrimeagen). Big thanks to [teej dv](https://x.com/teej_dv) for the shoutout! 
  <Tweet id="1993736016293974245" />

&nbsp;

- [Effect Solutions](https://www.effect.solutions), a high-level, prescriptive guide for writing idiomatic Effect programs by [Kit Langton](https://x.com/kitlangton) has been published!
  <Tweet id="1992956545345441823" />

&nbsp;

- Kit also unveiled `doctor-effect`.
...
- Thomas Dupont wrote an article on [Medium](https://medium.com/) about [using Effect with Domain Driven Design](https://medium.com/@setni/domain-driven-design-and-functional-programming-with-effect-440686b51d5e?postPublishedType=initial).
...
- **Office Hours 9: Effect Solutions, Tooling, AI and LLM uses** is now on our YouTube Channel.

---
pagefind: false
title: "This Week in Effect - #111"
excerpt: Fiberplane & Supermemory using Effect. Office Hours 22 (PR roasting & ecosystem updates), Effect Berlin 🇩🇪 meetup, and new community tools.
date: 2026-03-27
authors:
  - davide_scognamiglio
  - mirela_prifti
...
This week, the [acemate.ai team](http://acemate.ai/), Jan Tiegges, and Tom Favre successfully wrapped up the 3rd edition of Effect Berlin 🇩🇪 meetup! We're very grateful to acemate.ai for hosting, and to everyone who joined and made it a great, educational evening around Effect!
...
- The best "skill" for AI agents using Effect? Clone the Effect repo.

  <Tweet id="2035717444447183087" />

&nbsp;

- [Supermemory](https://supermemory.ai/) was built in a completely composable way with Effect!

  <Tweet id="2035524546250567997" />

&nbsp;

- Hear how Fiberplane is using Effect to build a self-driving codebase.

  <Tweet id="2037190338847424535" />

&nbsp;

- Dealing with time-based logic in TypeScript? Use Effect’s [TestClock](https://effect.website/docs/testing/testclock/) for easy, reliable testing.

  <Tweet id="2036377100886655343" />

&nbsp;

- [expect](https://github.com/millionco/expect/tree/776b3e4c15e5a4ac10bea2d8f09f33d58e16353f) - a tool for letting agents test your code in a real browser. Priject by the Million Software team.

&nbsp;

- [effect-jetbrains-plugin](https://github.com/kriegcloud/effect-jetbrains-plugin) – JetBrains plugin for @effect/tsgo language-server support and Effect runtime Dev Tools. Project by elpresidank.

&nbsp;

- [effect-analyzer](https://jagreehal.github.io/effect-analyzer/) – static analysis for Effect code. Project by Jag Reehal.

&nbsp;

- [audius-mcp-atris](https://github.com/glassBead-tc/audius-mcp-atris) – a Code Mode MCP server using Effect for the Audius web3 music platform. Project by glassBead.

&nbsp;

- The [Effect Schema course](https://www.effective.software/courses/effect-schema) by Hemanta Kumar Sundaray got 2 new chapters: optional/nullable fields and Standard Schema Integration.
...
<YouTube
  ...
  title="Roasting PRs & ecosystem updates | Effect Office Hours 22 🔥"
/>
...
<YouTube id="https://www.youtube.com/embed/6CRKNN30XOo" title="Effect.all" />
...
<YouTube id="https://www.youtube.com/embed/WXkBvPhrmZY" title="Effect v4 CLI" />
...
<YouTube id="https://www.youtube.com/embed/rP7AsCDMqtY" title="Effect.Retry" />

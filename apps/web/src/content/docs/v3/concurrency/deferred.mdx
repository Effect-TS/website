...
| `Deferred.done`         | Completes the deferred with an [Exit](/docs/v3/data-types/exit/) value.                                         |
...
| `Deferred.failCause`    | Fails or defects the deferred with a [Cause](/docs/v3/data-types/cause/).                                       |

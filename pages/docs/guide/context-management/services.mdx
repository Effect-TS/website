...
```ts file=<rootDir>/src/guide/context-management/services/program-pipe.ts#L10-
...
```ts file=<rootDir>/src/guide/context-management/services/multiple-pipe.ts#L1-L22
...
```ts file=<rootDir>/src/guide/context-management/services/multiple-gen.ts
...
```ts file=<rootDir>/src/guide/context-management/services/multiple-pipe.ts#L24-L37
...
```ts file=<rootDir>/src/guide/context-management/services/multiple-pipe.ts#L39-L48

```

and then provide the entire context using the `provideContext` function:

```ts file=<rootDir>/src/guide/context-management/services/multiple-pipe.ts#L50-

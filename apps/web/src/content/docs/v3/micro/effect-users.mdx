...
The `MicroExit` type is a streamlined version of the [Exit](/docs/v3/data-types/exit/) type, designed to capture the outcome of a `Micro` computation.
...
The `MicroCause` type is a streamlined version of the [Cause](/docs/v3/data-types/cause/) type.
...
The `MicroSchedule` type is a streamlined version of the [Schedule](/docs/v3/scheduling/introduction/) type.

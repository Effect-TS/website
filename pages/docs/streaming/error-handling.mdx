...
```ts file=<rootDir>/src/streaming/error-handling/orElse.ts
...
```ts file=<rootDir>/src/streaming/error-handling/orElseEither.ts
...
```ts file=<rootDir>/src/streaming/error-handling/catchAll.ts
...
```ts file=<rootDir>/src/streaming/error-handling/catchAllCause.ts
...
```ts file=<rootDir>/src/streaming/error-handling/catchSome.ts

```

To recover from a specific cause, you can use the `Stream.catchSomeCause` function:

```ts file=<rootDir>/src/streaming/error-handling/catchSomeCause.ts
...
```ts file=<rootDir>/src/streaming/error-handling/onError.ts
...
```ts file=<rootDir>/src/streaming/error-handling/retry.ts
...
```ts file=<rootDir>/src/streaming/error-handling/refineOrDie.ts
...
```ts file=<rootDir>/src/streaming/error-handling/timeout.ts
...
```ts file=<rootDir>/src/streaming/error-handling/timeoutFail.ts
...
```ts file=<rootDir>/src/streaming/error-handling/timeoutFailCause.ts
...
```ts file=<rootDir>/src/streaming/error-handling/timeoutTo.ts

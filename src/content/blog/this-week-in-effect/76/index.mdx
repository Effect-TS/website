...
excerpt: Effect 3.17 is here! Key highlights - Effect RPC + TanStack Query setup by Michael Fester, Effect HTTP API with Next.js by Ethan Niser, live sessions on building a GitHub Action, local-first apps, Effect CLI, and more!
date: 2025-07-25
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- [Fix Layer.mock dual detection](https://github.com/Effect-TS/effect/pull/5277) (Bug Fix)
...
- Michael Fester showcased the **Effect RPC + TanStack Query** setup he's using at [14.ai](https://14.ai/).
...
- Ethan is also working on a **streaming hydration support for effect rx**
  <Tweet id="1947910291922292874" />

&nbsp;

- [StudioCMS](https://studiocms.dev/) shared their recent migration to Effect, [Beta 19, an Effectful Update](https://studiocms.dev/blog/beta-19-release), where they went over all the changes.

&nbsp;

- Another [Effect Playground](https://kishore.app/effect/playground) by Kishore, this time with trace visualization.
  <Tweet id="1946632127501762852" />

&nbsp;

- One more episode of **Implementing RFC-1035 (DNS) with EffectTS 🚀** and two more of **Experimenting with EffectTS, S3, and Vercel** by Dillon Mulroy on his Twitch channel.
...
Maxwell Brown and Kit Langton were live on X and Twitch with **Building a GitHub Action with Effect** and **Building a CLI Application With Effect**.

<Tweet id="1947306965711126931" />

&nbsp;

<Tweet id="1948391594597478560" />
...
- **coteach.ai** is looking for a Software Engineer – see the job posting in the `#job-board` channel on [our Discord](https://discord.com/channels/795981131316985866/796153351372275743/1394724166309253290) and DM _Peter Edmonds_ for further info.

- **Small SaaS team** is looking for a part-time Effect Developer to implement Effect in their stack. The job posting is available in the `#job-board` channel on [our Discord](https://discord.com/channels/795981131316985866/796153351372275743/1397684638834491412), DM _jonpage_ for further info.

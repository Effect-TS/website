---
pagefind: false
title: "This Week in Effect - #117"
excerpt: "Effect Miami 🇺🇸 meetup! Vibe Engineering Effect Apps at the AI Engineer Europe. HttpApiTest & acquireDisposable in v4 Beta. sqlfu gets @effect/sql support."
date: 2026-05-08
authors:
  - davide_scognamiglio
  - mirela_prifti
...
We're excited to announce that the first [Effect Miami Meetup](https://luma.com/eyp4vnq5) 🇺🇸 has been scheduled on May 28, organized by Ariel Azoulay, and hosted by The LAB Miami.
...
- `@effect/sql` support coming to sqlfu! 🔥

  <Tweet id="2051620858888589344" />

&nbsp;

- Looking for large open-source Effect codebases to learn from?
...
- [pi-effect-harness](https://github.com/mpsuesser/pi-effect-harness) - a Pi extension that enforces Effect v4 best practices during agent-assisted coding sessions.

&nbsp;

- [@nmnmcc/ability](https://github.com/nmnmcc/ability) - an authorization library bringing Effect-style programming to permission checking.

&nbsp;

- [effect-uai](https://effect-uai.betalyra.com) - effectful building blocks for agentic AI by [Betalyra](https://betalyra.com).

&nbsp;

- [s20-wifi-setup](https://github.com/kachkaev/s20-wifi-setup) - a TypeScript command-line tool for connecting legacy Orvibo WiWo S20 smart sockets to Wi-Fi networks.

&nbsp;

- [@siebix/cloudflare-browser-run-effect](https://github.com/siebix-studio/effect-reusables/tree/main/packages/cloudflare-browser-run-effect) - an Effect service library providing typed schemas and utilities for Cloudflare Browser Run Quick Actions.
...
- Vibe Engineering Effect Apps by Michael Arnaldi at the AI Engineer Europe in London.
  ...
  <YouTube
    id="https://www.youtube.com/embed/Wmp2Tku2PrI?si=Kd9cl4zpEZcBHd0H"
...
- Roasting Julius' code in T3 Code
  ...
  <YouTube
    id="https://www.youtube.com/embed/gMWpWQ6XooA?si=X9u3ul9M2fNOQPq6"

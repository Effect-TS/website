...
export const Video = () => {
  ...
  return (
    <div className="relative">
      <Card>
        {showVideo ? (
          ...
          <div className="relative aspect-video">
            <Image src="/images/video-thumbnail.jpg" alt="Effect: Next-Generation TypeScript" fill className="object-cover object-center" />
      ...
      <div className="absolute -inset-y-64 w-32 left-1/2 rotate-45 bg-white/10 blur-3xl pointer-events-none" style={{borderRadius: '50% 50%'}} />
    </div>
  )
}

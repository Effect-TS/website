...
- [Deploy website after v3 package releases](https://github.com/Effect-TS/effect/pull/7092)
...
Looking for a role where you can work with Effect? We now have a dedicated [Effect jobs page](https://www.effect.website/effect-jobs) with open roles from companies using Effect.

...
In an Effect program, it is common to encounter expected errors. These errors, also referred to as "failures," "typed errors,"
...
Unexpected errors, also known as _defects_, _untyped errors_, or _unrecoverable errors_, are errors that developers

...
const program = Effect.gen(function* () {
  const fiber = yield* Effect.forkChild(writeFileWithCleanup("example.txt", "Some long data..."))
...
<Aside type="note" title="Running Effects">
  ...
  [Running Effects](/docs/v4/getting-started/running-effects/#runsync) for more details).
</Aside>
...
<Aside type="note" title="Running Effects">
  ...
  documentation on [zipping](/docs/v4/getting-started/control-flow/#zipwith) for more details).
</Aside>

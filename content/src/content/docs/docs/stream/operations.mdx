---
title: Operations
description: Learn essential operations for manipulating and managing data in streams, including tapping, taking, mapping, filtering, grouping, merging, interleaving, buffering, and debouncing.
sidebar:
  order: 4
---
...
If you need only the final accumulated value, you can use [Stream.runFold](/docs/stream/consuming-streams/#using-fold-operations):

...
```ts filename="MeasuringCup.ts" file=<rootDir>/src/tutorial/context-management/layers/MeasuringCup.ts
...
```ts filename="Ingredients.ts" file=<rootDir>/src/tutorial/context-management/layers/Ingredients.ts
...
```ts filename="Recipe.ts" file=<rootDir>/src/tutorial/context-management/layers/Recipe.ts
...
```ts filename="Recipe.ts" file=<rootDir>/src/tutorial/context-management/layers/Recipe-gen.ts
...
```ts filename="index.ts" file=<rootDir>/src/tutorial/context-management/layers/index.ts
...
```ts filename="index.ts" file=<rootDir>/src/tutorial/context-management/layers/index2.ts
...
```ts filename="index.ts" {27} file=<rootDir>/src/tutorial/context-management/layers/index-pipe.ts

```

The `Effect.forEach` function is used to iterate over a collection of values (`steps`) and perform a side effect on each element (`Effect.log`), discarding the result (`void`).

</Tab>
<Tab>

```ts filename="index.ts" {25} file=<rootDir>/src/tutorial/context-management/layers/index-gen.ts

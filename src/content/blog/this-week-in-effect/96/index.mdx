...
excerpt: Effect Institute by Kit Langton. The Case for Effect by Ryan Hunter. More Effect videos by Lucas Barake.
date: 2025-12-12
authors:
  - davide_scognamiglio
  - mirela_prifti
...
More upcoming features in Effect 4.0: we made it even simpler to connect apps to observability tools.

<Tweet id="1998069311714336922" />

[StandardAST module](https://github.com/Effect-TS/effect-smol/pull/800), a standard, introspectable way to represent a schema without functions, will be part of Schema v4.
...
- [Add basic apis for converting to web Request/Response](https://github.com/Effect-TS/effect/pull/5896) (Feature)
...
Our upcoming [Effect Vienna 🇦🇹](https://luma.com/rc84shks) Meetup on December 18th will feature talks by Mattia Manzati and Sebastian Lorenz. [Join the meetup!](https://luma.com/rc84shks)
...
- Sign up for [Effect Institute](https://www.effect.institute/chapters), the upcoming Effect tutorial series by Kit Langton.
  <Tweet id="1997656337778667587" />

&nbsp;

- [The Case for Effect](https://ryanhunter.io/the-case-for-effect/), article by Ryan Hunter.

&nbsp;

- **File Uploads in React with Effect-TS** & **TanStack Start with Effect-TS & Effect Atom** by Lucas Barake.
  <YouTube
...
<YouTube
  id="https://www.youtube.com/embed/xKQcedkMLPs?si=u1xazu5BHIV51mJm"
  title="TanStack Start with Effect-TS & Effect Atom"
/>

&nbsp;

- A native Effect driver from the Drizzle team.

...
```ts {25} file=<rootDir>/src/guide/observability/otel/tracing/print-withSpan.ts
...
```ts {32} file=<rootDir>/src/guide/observability/otel/tracing/print-withSpan-fail.ts
...
```ts {32} file=<rootDir>/src/guide/observability/otel/tracing/annotateCurrentSpan.ts
...
```ts {33-40} file=<rootDir>/src/guide/observability/otel/tracing/log-withSpan.ts

...
excerpt: "Mike recaps the Astra incident: one Queue bug, 207 PRs, three days. Effect v4 RC renames Schema.transformOrFail to Schema.transformEffect. The Primeagen dives into Effect with 'Learning EffectJS'. Ziverge runs its first Effect Training Workshop."
date: 2026-09-11
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- [effect-lsc](https://github.com/pigoz/effect-lsc) - Effect Live Server Components, a backend-first UI framework bringing Phoenix LiveView-style architecture to TypeScript: components run server-side as Effects while a 6.2 KB browser runtime handles DOM updates over WebSocket. By Stefano Pigozzi.

...
console.log(Schema.decodeUnknownSync(schema)({ quantity: "1" }))
// Output: { quantity: 1 }
console.log(Schema.decodeUnknownSync(schema)({}))
// Output: {}
console.log(Schema.decodeUnknownSync(schema)({ quantity: undefined }))
// Output: { quantity: undefined }

// Encoding examples

console.log(Schema.encodeSync(schema)({ quantity: 1 }))
// Output: { quantity: "1" }
console.log(Schema.encodeSync(schema)({}))
// Output: {}
console.log(Schema.encodeSync(schema)({ quantity: undefined }))
// Output: { quantity: undefined }
```
...
//      ▼
const from = schema.fields.quantity.from
```
...
console.log(Schema.decodeUnknownSync(schema)({ quantity: undefined }))
// Output: { quantity: undefined }
console.log(Schema.decodeUnknownSync(schema)({ quantity: null }))
// Output: {}
...
| Operation    | Behavior                                                      |
| ------------ | ------------------------------------------------------------- |
| **Decoding** | Uses the default value if the input is missing or `undefined` |

...
```ts file=<rootDir>/src/streaming/operations/tap.ts
...
```ts file=<rootDir>/src/streaming/operations/take.ts
...
```ts file=<rootDir>/src/streaming/operations/map.ts
...
```ts file=<rootDir>/src/streaming/operations/mapEffect.ts
...
```ts file=<rootDir>/src/streaming/operations/mapEffectPar.ts
...
```ts file=<rootDir>/src/streaming/operations/mapAccum.ts
...
```ts file=<rootDir>/src/streaming/operations/mapConcat.ts
...
```ts file=<rootDir>/src/streaming/operations/as.ts
...
```ts file=<rootDir>/src/streaming/operations/filter.ts
...
```ts file=<rootDir>/src/streaming/operations/scan.ts
...
```ts file=<rootDir>/src/streaming/operations/runFold.ts
...
```ts file=<rootDir>/src/streaming/operations/drain-empty.ts
...
```ts file=<rootDir>/src/streaming/operations/drain.ts
...
```ts file=<rootDir>/src/streaming/operations/changes.ts
...
```ts file=<rootDir>/src/streaming/operations/zip.ts
...
```ts file=<rootDir>/src/streaming/operations/zipAll.ts
...
```ts file=<rootDir>/src/streaming/operations/zipLatest.ts
...
```ts file=<rootDir>/src/streaming/operations/zipWithPrevious.ts
...
```ts file=<rootDir>/src/streaming/operations/zipWithIndex.ts
...
```ts file=<rootDir>/src/streaming/operations/cross.ts
...
```ts file=<rootDir>/src/streaming/operations/partition.ts
...
```ts file=<rootDir>/src/streaming/operations/partitionEither.ts
...
```ts file=<rootDir>/src/streaming/operations/groupByKey.ts
...
```ts file=<rootDir>/src/streaming/operations/groupBy.ts
...
```ts file=<rootDir>/src/streaming/operations/grouped.ts
...
```ts file=<rootDir>/src/streaming/operations/groupedWithin.ts
...
```ts file=<rootDir>/src/streaming/operations/concat.ts
...
```ts file=<rootDir>/src/streaming/operations/concatAll.ts
...
```ts file=<rootDir>/src/streaming/operations/flatMap.ts
...
```ts file=<rootDir>/src/streaming/operations/merge.ts
...
```ts file=<rootDir>/src/streaming/operations/merge-haltStrategy.ts
...
```ts file=<rootDir>/src/streaming/operations/mergeWith.ts
...
```ts file=<rootDir>/src/streaming/operations/interleave.ts
...
```ts file=<rootDir>/src/streaming/operations/interleaveWith.ts
...
```ts file=<rootDir>/src/streaming/operations/intersperse.ts
...
```ts file=<rootDir>/src/streaming/operations/intersperseAffixes.ts
...
```ts file=<rootDir>/src/streaming/operations/broadcast.ts
...
```ts file=<rootDir>/src/streaming/operations/buffer.ts
...
```ts file=<rootDir>/src/streaming/operations/debounce.ts

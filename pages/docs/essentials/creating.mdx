...
This is because `program` represents the action of writing to the console, but nothing happens until you explicitly [run your program](running).
...
Check out the next guide on [Running Effects](running) to find out more.

...
## Using Sentry with Open Telemetry

Using sentry with effect is very similar to using effect with opentelemetry, you just have to swap the `spanProcessor` with the sentry implementation:

...
excerpt: Adding persistence to Effect AI SDK. Effect Milan Meetup Announcement. New Q&A format launch. ChEffect and Twitch – Spotify Integration development coding sessions.
date: 2025-09-26
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- We're excited to announce that the first [Effect Milan Meetup](https://luma.com/ey6avxtv) 🇮🇹 is happening on October 16th.
  <Tweet id="1970518220298953166" />

&nbsp;

- In the latest episode of the [Happy Path Programming](https://www.youtube.com/@HappyPathProgramming) podcast, Sam Goodwin, creator of [Alchemy](https://alchemy.run), delved into his Infrastructure as Code approach and the upcoming “Infrastructure-as-Effects” project.
...
- [Landry Monga](https://github.com/lvndry) published [Jazz](https://github.com/lvndry/jazz), an agentic automation CLI built for managing agentic loops in daily life workflows, backened by Effect.

&nbsp;
## Effect Content Update

Kit Langton and Maxwell Brown livestreamed the first episode of **Effect Office Hours**, our latest live Q&A format, where we engage with the community answering questions, debugging code, and making educational Effect-y things!

...
excerpt: "OpenCode 1.17.3 can now reference the Effect git repo directly 🚀. Intro to Effect Miami, by Ariel Azoulay (Effect Miami 🇺🇸). Effect v4 Beta: tree-shaking, Schema fixes & a key Entity reliability fix."
date: 2026-06-12
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- OpenCode 1.17.3 can now directly reference Effect git repo🚀

  <Tweet id="2064785435239276761" />
...
- [Effect Guide](https://effect-guide.netlify.app/?utm_source=discord&utm_medium=community&utm_campaign=launch) - a free guide made by *obadakhalili*, explaining why Effect exists and its benefits, paired with a technical deep-dive that rebuilds core parts of the library from scratch.

&nbsp;

- [Verrex](https://m9tdev.github.io/verrex/) - a guided tour of an Effect-native UI framework where Effect's `E`/`R` channels survive to compile-time, so forgetting a service `Layer` becomes a compile error that names it.

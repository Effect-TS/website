...
excerpt: Effect, the Good Parts, use workflow, and Vercel Domains by swyx. Effect + Next.js, Managed Runtimes, Middleware, DX Improvements by Mattia Crovero. Effect Office Hours 6.
date: 2025-10-31
authors:
  - davide_scognamiglio
  - mirela_prifti
...
An updated version of the [Effect LSP](https://github.com/Effect-TS/language-service) with the Layer Outline Graph is now available!
...
- Last week's [teej dv](https://x.com/teej_dv)'s educational stream with [Kit Langton](https://x.com/kitlangton) is now on YouTube.
  <YouTube
...
- teej dv also live streamed some Effect development with Dillon Mulroy.
   <Tweet id="1982812807352418652" />

&nbsp;

- A reminder that the next Effect NYC Meetup is happeniing on Nov 19. Be sure to register for the event and subscribe to [Effect Community Events](https://luma.com/effect-community?k=c) calendar to stay on track with upcoming events.
   <Tweet id="1982797450613055565" />

&nbsp;

- **Effect: the Good Parts, `use workflow`, and Vercel Domains — Dillon Mulroy** by [swyx](https://www.youtube.com/@swyxTV).
  <YouTube
...
A little extract from [Sebastian Lorenz](https://x.com/thefubhy)'s talk at the TypeScript Munich Meetup.
   <Tweet id="1982127744579260903" />

&nbsp;

- Shoutout to [Rhys Sullivan](https://x.com/RhysSullivan) and the Vercel team for shipping the Vercel Domains MCP in 1 day using the Effect MCP!
...
- Dillon Mulroy livestreamed his new series **Building a family recipe app with LiveStore, Effect, and CF Workers**.

  <TwitchPlayerNonInteractive video="2605152345" />
...
## Effect Content Update
 ...
 - The sixth episode of **Effect Office Hours** aired on Wednesday! We will publish an edited version on our YouTube channel soon. In the meantime, you can watch the livestream on X(Twitter) below.
   <Tweet id="1983610096824590787" />

&nbsp;

- The second talk from the Effect Milan Meetup 2025, **Effect + Next.js: Managed Runtimes, Middleware, DX Improvements** by Mattia Crovero, is now on YouTube.
  <YouTube

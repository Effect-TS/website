...
excerpt: "Effect v4 has officially moved to Release Candidate! The first Effect Warsaw Meetup is scheduled for September 15. New community projects: effect-domain, repo-dive, and a new Retrieval-Augmented Generation course."
date: 2026-08-14
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- 6550+ community members on [Discord](https://discord.gg/effect-ts).
...
- We're thrilled to announce that the first [Effect Warsaw](https://luma.com/29fn6spj) Meetup is scheduled on September 15!
...
New this week: **Superwall** is hiring a Global Remote (US timezones preferred) Support Engineer.

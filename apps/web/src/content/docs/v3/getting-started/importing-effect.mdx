...
For detailed installation instructions for platforms like Deno or Bun, refer to the [Installation](/docs/v3/getting-started/installation/) guide, which provides step-by-step guidance.
...
So, let's take the first step and explore the fundamental concepts of the [The Effect Type](/docs/v3/getting-started/the-effect-type/).

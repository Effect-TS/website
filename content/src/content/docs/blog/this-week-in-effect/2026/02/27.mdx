...
- [`effect-slack`](https://github.com/MateoKruk/effect-slack) - A type-safe Effect-native Slack SDK. Project by [MateoKruk](https://github.com/MateoKruk).

&nbsp;

- [`maple`](https://github.com/Makisuo/maple) - An OpenTelemetry observability platform officially launched this week. Project by [Makisuo](https://github.com/Makisuo).

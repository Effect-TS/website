    ...
    <div className="relative mt-7">
      <div className="w-full bg-gradient-to-br from-zinc-500 to-zinc-800 p-px rounded-xl overflow-hidden [.code-output_&]:rounded-b-none">
        <div className="bg-zinc-950 rounded-[11px] [.code-output_&]:rounded-b-none">
          <div className="flex justify-between items-center pr-2 border-b border-zinc-800">
            <div className="flex">
              ...
              {filename && (
                <div className="h-10 px-3 flex items-center border-r border-zinc-800 font-mono text-sm text-zinc-800 dark:text-zinc-300">
                  {filename}
                </div>
              )}
            </div>
            <button
              onClick={copy}
              className="h-6 rounded-lg p-px shadow-lg bg-gradient-to-br from-zinc-300 to-zinc-500"
            >

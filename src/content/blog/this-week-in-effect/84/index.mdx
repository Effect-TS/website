...
excerpt: Cause & Effect episode with the CTO of Spiko! Effect AI SDK Release ✨. Building a CLI Application coding session.
date: 2025-09-19
authors:
  - davide_scognamiglio
  - mirela_prifti
...
**Effect AI SDK** is out! More flexibility. Better ergonomics. More power for the end-user.
...
- [Preserve precision of histogram metric boundary values](https://github.com/Effect-TS/effect/pull/5533) (Bug Fix)
...
- [Add onOpen option to Socket.run](https://github.com/Effect-TS/effect/pull/5517) (Feature)
- [Attempt to prevent InterruptedException leaks into entity replies](https://github.com/Effect-TS/effect/pull/5527) (Bug Fix)
- [Fix the instructions for calling an RPC in the RPC readme](https://github.com/Effect-TS/effect/pull/5536) (Documentation Update)
...
This episode features Samuel Briole, CTO of [Spiko](https://www.spiko.io/), a Paris-based FinTech startup building infrastructure for issuing regulated financial products on public blockchains, specifically risk-free products.
...
- Mattia Manzati, Effect Core Contributor & Founding Engineer at Effectful Technologies, presented Effect at _SquiggleConf_, a conference for web tooling in Boston.
  <Tweet id="1969050207426887757" />

&nbsp;

- The first [Effect Nice Meetup](https://www.eventbrite.fr/e/atondev-introduction-a-effectts-par-la-pratique-tickets-1685513629639) 🇫🇷 is happening on October 23rd, organized by [Hugo Muffraggi](https://www.linkedin.com/in/hugo-mufraggi-5b081b134/) and the [À ton dev](https://www.linkedin.com/company/%C3%A0-ton-dev/about/) association. The event will be in French.

&nbsp;

- [Designing Production Agent Systems with Effect](https://dpas.theryanhunter.com/), a book by Ryan Hunter.
  <Tweet id="1967629053655126184" />

&nbsp;

- [`printify-effect`](https://github.com/Malvolio/printify-effect), a TypeScript library that wraps the Printify REST API using Effect patterns and provides a type-safe, functional interface for interacting with Printify's print-on-demand services. By Michael Lorton.

&nbsp;

- [`@effect-ak/aws-sdk`](https://github.com/effect-ak/aws-sdk), a library that generates Effect wrappers for the AWS SDK in TypeScript, making errors explicitly typed for operations like uploading to S3. By Aleksandr Kondaurov.

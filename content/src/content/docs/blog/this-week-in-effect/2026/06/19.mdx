...
excerpt: "Effectifying OpenCode with Kit Langton on Cause & Effect Podcast. Services & Layers in Production, talk by Leonardo Trapani from Datapizza. Effect Paris 🇫🇷 meetup on June 25. HttpApi streaming support lands in v4 Beta."
date: 2026-06-19
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- [Fix (ai-openai): Ignore unrecognized events rather than cancelling the event stream](https://github.com/Effect-TS/effect/pull/6281) (Bug Fix)

### Effect Platform
- [Fix(platform): scope HttpLayerRouter.addHttpApi error encoder to its own routes](https://github.com/Effect-TS/effect/pull/6244) (Bug Fix)
...
We're excited to announce the [Effect Paris Meetup #7](https://www.meetup.com/fr-fr/effect-paris/events/315270449/?eventOrigin=group_upcoming_events), scheduled on June 25th, sponsored and organized by [evryg](https://www.evryg.com/en)!

  <Tweet id="2067492007027630385" />

And if you're in Miami 🌴, [Effect Miami #1.5 (Hack Night!)](https://luma.com/39g19zzf) is also scheduled on June 30th -- a focused hack night for engineers interested in learning Effect and using coding agents to write more correct, reliable Effect code! The meetup is organized by Ariel Azoulay, in collaboration with Hack Nights, Miami’s weekly builder meetup.
...
- [HumanLayer](https://www.humanlayer.dev/) migrating to Effect! 🔥
...
- **OpenRouter** is looking for [Effect engineers](https://x.com/louis_g_v/status/2067841625418588233). DM [Louis](https://x.com/louis_g_v), the co-founder, on X for further info.
...
- **SailPoint**: [Platform Engineer - AI Tooling (REMOTE)](https://sailpoint.wd1.myworkdayjobs.com/en-US/SailPoint/job/Platform-Engineer---AI-Tooling--REMOTE-_R012408-1)

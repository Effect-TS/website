      ...
      const notifyForExample =
        ...
        (message, options) =>
          Effect.withFiber((fiber) => {
            ...
            const details = Context.getOrUndefined(
              span.annotations,
              ExampleStep,
            )
...
const nanosToMilliseconds = (nanos: bigint): number =>

...
excerpt: Effect Institute Official Launch. Effect Berlin Meetup 2 announcement. Effect Office Hours 11 and ChEffect code session.
date: 2026-01-09
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- The [Effect community](https://discord.gg/effect-ts) on Discord reached 5970+ members!
...
- Kit Langton officially launched the Effect Institute.🚀
  <Tweet id="2008889797939802276" />

&nbsp;

- [Effect Berlin Meetup #2](https://luma.com/xdpn0t7a) is happening on January 29, 2026. Join the community for discussions and networking.
...
- Makisuo optimized [Hazel](https://github.com/HazelChat/hazel) initial load speed using Effect tracing, reducing startup time from 2 seconds to 400ms on cold start and 8ms when cached. Hazel is a full-stack, real-time collaborative chat platform with local-first architecture, built with Effect-TS, ElectricSQL, and React 19.
...
- Nir Tamir's talk at NodeTLV '25 on **smarter error handling with Effect**.

<YouTube
  id="https://www.youtube.com/embed/Y25Ih4VRfjg?si=wdteDg6z8PshrUDZ"
  title="Nir Tamir @ NodeTLV '25 | TypeScript Without Surprises: Smarter Error Handling with Effect-TS"
/>

&nbsp;

- [`effect-slack`](https://github.com/MateoKruk/effect-slack) - An Effect-native Slack SDK with 272 methods across 33 services, featuring full TypeScript type safety, built-in OpenTelemetry instrumentation, and smart retry mechanisms. Project by [Mateo Kruk](https://github.com/MateoKruk).

&nbsp;

- Adam Josefus open-sourced [`fx-fetch`](https://adamjosefus.github.io/fx-fetch/), the production-ready HTTP fetching library built with Effect.

&nbsp;

- [`create-epoch-app`](https://github.com/RhysSullivan/create-epoch-app) - An opinionated full-stack starter template combining Effect, Convex, and Next.js 15 in a monorepo structure. Project by [Rhys Sullivan](https://github.com/RhysSullivan).
...
- [`honertia`](https://github.com/PatrickOgilvie/honertia) - An Inertia.js adapter for Hono that brings Laravel-style development patterns to Cloudflare Workers with Effect-based handlers. Project by [Patrick Ogilvie](https://github.com/PatrickOgilvie).

&nbsp;

- [`effstate`](https://github.com/Handfish/effstate) - An Effect-based state machine library with type-safe transitions, dependency injection, and hierarchical state structures. Features 30x faster event processing and significantly smaller bundle size compared to alternatives. Project by [Handfish](https://github.com/Handfish).
...
- The 11th episode of **Effect Office Hours** went live on Wednesday! We will publish an edited version on our YouTube channel soon. In the meantime, you can watch the [livestream on X(Twitter)](https://x.com/EffectTS_/status/2008917561724092741)
...
- A **consumer music startup** hiring for Effect Backend Consultant + a full time role based in NYC. The job posting is available in the `#job-board` channel on [our Discord](https://discord.com/channels/795981131316985866/796153351372275743/1457499793042575371)

...
- Don't miss this week's **Effect Office Hours** episode (link in the Effect Content section). We had the pleasure to have Sam with us presenting **Alchemy v2**!

  <Tweet id="2049519544562295016" />

&nbsp;

- This talk could be named: **You should really use Effect!** And the funny thing is Effect isn't even mentioned. Props to [Matt Pocock](https://x.com/mattpocockuk)
...
- Dominick just shipped [Lensflare](https://lensflare.dev) - an open-source macOS development observability stack for humans and AI agents. Built with Effect.
...
- We could not agree more!
  ...
  <Tweet id="2049379929666543909" />

&nbsp;

- 👀

  <Tweet id="2049565600876581121" />
...
- [Foldkit DevTools MCP](https://foldkit.dev/ai/mcp) – Just shipped DevTools MCP for Foldkit. Agents can now read the current Model, list and inspect Message history, rewind the UI to any past Model, and dispatch Messages into the runtime.

...
excerpt: "Dax Raad headlining Effect Miami 🇺🇸! Foldkit in Office Hours 🔥 Platform Crypto & Stream.broadcastN in v4 Beta. effect-cf, effect-hatchet & more!"
date: 2026-05-22
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- 6420+ community members on [Discord](https://discord.gg/effect-ts).
- 14k GitHub stars! 🌟
...
The v4 beta had one of its most active weeks yet, with a major push on documentation quality, new stream and CLI primitives, and several notable API refinements — here are the most notable changes that landed in `effect-smol`.
...
With the hype building around the next Effect Miami Meetup, we're looking for some help organizing a **meetup in San Francisco** as well. If you're interested, feel free to reach out.

  <Tweet id="2055772970073948422" />


The **Effect Miami** Meetup just announced [Dax Raad](https://x.com/thdxr) as main speaker!

  <Tweet id="2056406724068721002" />


Don't miss our upcoming meetups: the [Effect Vienna 🇦🇹](https://luma.com/c49s62t2) on May 27, sponsored by Sentry, and [Effect Miami 🇺🇸](https://luma.com/eyp4vnq5) on May 28, hosted by The LAB Miami, and the [Effect Milan 🇮🇹](https://luma.com/yirm3nb7) on June 11, hosted & co-organized by [Datapizza](https://datapizza.tech/it/).
...
- We had the pleasure to host Devin, builder of [Foldkit](https://foldkit.dev/), in this week's **Office Hours** episode. You can find the full stream in the Effect Content section below.

  <Tweet id="2057125240866476159" />

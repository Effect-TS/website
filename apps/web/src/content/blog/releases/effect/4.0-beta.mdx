...
date: 2026-02-18
featured: true
featuredImage: ./4.0-beta/featured.png
authors:
  - maxwell_brown
tags:
  - effect-v4-updates
...
import bundleSizeVizSrc from "./4.0-beta/video/bundle-size-viz.mp4"
import corePackageSrc from "./4.0-beta/video/core-package.mp4"
import VideoFigure from "@/components/blog/VideoFigure.astro"
...
<VideoFigure
  src={bundleSizeVizSrc}
  title="Effect bundle size comparison"
  description="Silent animation comparing v3 and v4 bundle sizes. A minimal program using Effect, Stream, and Schema drops from roughly 70 kB to about 20 kB."
/>
...
<VideoFigure
  src={corePackageSrc}
  title="Effect package consolidation"
  description="Silent animation showing previously separate packages moving into the core effect package. Platform-, provider-, and technology-specific implementations remain separate, as listed above."
/>

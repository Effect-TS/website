---
pagefind: false
title: This Week in Effect - 2026-07-03
excerpt: "Three new Effect videos from Lucas Barake. v4 Beta: correctness fixes, URL API refinements, and more."
date: 2026-06-26
authors:
  - davide_scognamiglio
  - mirela_prifti
...
The v4 beta opened July with a focused week on correctness fixes, URL API refinements, and an expanding AI documentation effort.
...
Here you can find the recaps of all [**Effect v4 Beta updates**](https://effect.website/blog/tags/effect-v4-beta-recaps/), organized by topic, so you can jump straight to what matters most to you.
...
- A reminder that [Effect Miami #2](https://luma.com/ly80tuif) is scheduled on July 14, with [David Khourshid](https://x.com/DavidKPiano) joining as main speaker.
...
- Welcome, Roderick! 🖤🤍
  ...
  <Tweet id="2072227360850559205" />

&nbsp;

- Gabe De Mesa (OpenGov) featured Effect in this presentation @ AI Engineer Conf 2026:
...
- Welcome to the tribe, Christian!
  ...
  <Tweet id="2069516489305030680" />

&nbsp;

- [effect-typed-id](https://github.com/just-be-dev/effect-typed-id) – TypeID specification implemented as a TypeScript library for the Effect runtime: type-safe, branded UUIDv7 identifiers encoded as strict lowercase base32 with an optional snake_case prefix. Project by just-be-dev.

&nbsp;

- [frond](https://github.com/frondruntime/frond) – An Effect-powered frontend runtime for React and MobX-facing application state, offering an explicit runtime graph with keyed node identity, dependency readiness, serialized operations, cancellation, cleanup, eviction, diagnostics, and React Suspense integration. Project by frondruntime.
...
- [The Schema is Truth: A Categorical Fever Dream for Those with the Huevos](https://github.com/beep-effect/beep-effect/blob/main/THE_SCHEMA_IS_TRUTH_A_CATEGORICAL_FEVER_DREAM_FOR_THOSE_WITH_THE_HUEVOS.md) – A technical manifesto recounting how embedding business logic directly into schemas deleted 1,200+ lines of code — and how that practical intuition turned out to be mathematically grounded in catamorphisms and category theory. By elpresidank.

...
workspace: basics/100-welcome
---

Welcome to the Effect tutorial!
...
To the right is an editor & console window. As you make changes to the code in the editor, the program will re-run and show the output in console.

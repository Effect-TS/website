...
We will use **layers** to construct the `Database` service instead of providing a service implementation directly as we did in the [Managing Services](/docs/requirements-management/services/) page.

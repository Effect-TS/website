...
- For basic parsing inside clients we recommend to [build JSONSchema](https://effect-ts.github.io/effect/schema/JSONSchema.ts.html#make) from Schemas, and e.g use the [jsonschema](https://www.npmjs.com/package/jsonschema) (4kb gz) library instead.

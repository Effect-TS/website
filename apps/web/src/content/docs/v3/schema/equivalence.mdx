...
The `Schema.equivalence` function allows you to generate an [Equivalence](/docs/v3/schema/equivalence/) based on a schema definition.
...
the most sensible form of equivalence is to use `Equal.equals` from the [Equal](/docs/v3/trait/equal/) module, which defaults to reference equality (`===`).

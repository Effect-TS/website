...
```ts filename="main.ts" file=<rootDir>/src/tutorial/context-management/layers/main.ts
...
```ts filename="main.ts" file=<rootDir>/src/tutorial/context-management/layers/main2.ts
...
```ts filename="main.ts" {27} file=<rootDir>/src/tutorial/context-management/layers/main-pipe.ts
...
```ts filename="main.ts" {25} file=<rootDir>/src/tutorial/context-management/layers/main-gen.ts

...
| `Effect.runFork`        | ⚠️ `Micro.runFork`        | returns a `Fiber` instead of a `RuntimeFiber` |
...
| Effect              | Micro                 |                                   |
| ------------------- | --------------------- | --------------------------------- |
| `Effect.fork`       | ⚠️ `Micro.fork`       | `Fiber` instead of `RuntimeFiber` |
| `Effect.forkDaemon` | ⚠️ `Micro.forkDaemon` | `Fiber` instead of `RuntimeFiber` |
| `Effect.forkIn`     | ⚠️ `Micro.forkIn`     | `Fiber` instead of `RuntimeFiber` |
| `Effect.forkScoped` | ⚠️ `Micro.forkScoped` | `Fiber` instead of `RuntimeFiber` |

---
pagefind: false
title: "This Week in Effect - #115"
excerpt: "Effect Vienna Meetup on May 27! 🎉 Building Clanka, an AI coding framework with Effect. New packages & APIs in Effect v4 Beta"
date: 2026-04-24
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- [[ISSUE-6009] (fix: ai-openai) Make strict mode configurable for tool definitions](https://github.com/Effect-TS/effect/pull/6174) (Bug Fix).
...
- [EFF-784 Backport workflow suspension failure fixes](https://github.com/Effect-TS/effect/pull/6196) (Bug Fix)
...
We're happy to announce the upcoming [Effect Vienna Meetup #2](https://luma.com/c49s62t2) on May 27, sponsored by [Sentry](https://sentry.io/welcome/).
...
- Just _don't_ listen to Mike.

  <Tweet id="2047352207524167925" />

&nbsp;

- 💯

  <Tweet id="2047181592095867060" />

&nbsp;

- The best way to start a project with Effect 👇

<Tweet id="2047368387181867357" />
...
- "Out of the box support for OpenTelemetry and OpenAPI like this is insanely nice!" That's right, Oscar! 😉

  <Tweet id="2046212911430008938" />

&nbsp;

- [effql](https://github.com/gloomweaver/effql) – sqlc-style TypeScript code generation for Effect SQL using Postgres introspection.
...
- [Effect Configuration course](https://www.effective.software/courses/effect-foundation/effect-configuration/introduction)

&nbsp;

- [effect-error-pretty.nvim](https://github.com/rashedInt32/effect-error-pretty.nvim) – A Neovim plugin that turns walls of `Effect<A, E, R>` assignability errors into readable diagnostics.

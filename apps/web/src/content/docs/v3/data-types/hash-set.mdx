...
- [HashSet](/docs/v3/data-types/hash-set/#hashset) - Immutable
- [MutableHashSet](/docs/v3/data-types/hash-set/#mutablehashset) - Mutable
...
Both `HashSet` and `MutableHashSet` use Effect's [`Equal`](/docs/v3/trait/equal/) trait to determine if two elements are the same. This ensures that each value appears only once in the set.
...
Effect's [`Data`](/docs/v3/data-types/data/) and [`Schema.Data`](/docs/v3/schema/effect-data-types/#interop-with-data) modules implement `Equal` for you automatically, based on structural equality.
...
| ------------ | -------------------------------------------------------- | ------------------------------------------- | --------------- |
| constructors | [empty](/docs/v3/api/effect/HashSet#empty)               | Creates an empty HashSet                    | O(1)            |
| constructors | [fromIterable](/docs/v3/api/effect/HashSet#fromIterable) | Creates a HashSet from an iterable          | O(n)            |
| constructors | [make](/docs/v3/api/effect/HashSet#make)                 | Creates a HashSet from multiple values      | O(n)            |
| elements     | [has](/docs/v3/api/effect/HashSet#has)                   | Checks if a value exists in the set         | O(1) avg        |
| elements     | [some](/docs/v3/api/effect/HashSet#some)                 | Checks if any element satisfies a predicate | O(n)            |
| elements     | [every](/docs/v3/api/effect/HashSet#every)               | Checks if all elements satisfy a predicate  | O(n)            |
| elements     | [isSubset](/docs/v3/api/effect/HashSet#isSubset)         | Checks if a set is a subset of another      | O(n)            |
| getters      | [values](/docs/v3/api/effect/HashSet#values)             | Gets an `Iterator` of all values            | O(1)            |
| getters      | [toValues](/docs/v3/api/effect/HashSet#toValues)         | Gets an `Array` of all values               | O(n)            |
| getters      | [size](/docs/v3/api/effect/HashSet#size)                 | Gets the number of elements                 | O(1)            |
| mutations    | [add](/docs/v3/api/effect/HashSet#add)                   | Adds a value to the set                     | O(1) avg        |
| mutations    | [remove](/docs/v3/api/effect/HashSet#remove)             | Removes a value from the set                | O(1) avg        |
| mutations    | [toggle](/docs/v3/api/effect/HashSet#toggle)             | Toggles a value's presence                  | O(1) avg        |
| operations   | [difference](/docs/v3/api/effect/HashSet#difference)     | Computes set difference (A - B)             | O(n)            |
| operations   | [intersection](/docs/v3/api/effect/HashSet#intersection) | Computes set intersection (A ∩ B)           | O(n)            |
| operations   | [union](/docs/v3/api/effect/HashSet#union)               | Computes set union (A ∪ B)                  | O(n)            |
| mapping      | [map](/docs/v3/api/effect/HashSet#map)                   | Transforms each element                     | O(n)            |
| sequencing   | [flatMap](/docs/v3/api/effect/HashSet#flatMap)           | Transforms and flattens elements            | O(n)            |
| traversing   | [forEach](/docs/v3/api/effect/HashSet#forEach)           | Applies a function to each element          | O(n)            |
| folding      | [reduce](/docs/v3/api/effect/HashSet#reduce)             | Reduces the set to a single value           | O(n)            |
| filtering    | [filter](/docs/v3/api/effect/HashSet#filter)             | Keeps elements that satisfy a predicate     | O(n)            |
| partitioning | [partition](/docs/v3/api/effect/HashSet#partition)       | Splits into two sets by a predicate         | O(n)            |
...
| ------------ | --------------------------------------------------------------- | ----------------------------------- | ---------- |
| constructors | [empty](/docs/v3/api/effect/MutableHashSet#empty)               | Creates an empty MutableHashSet     | O(1)       |
| constructors | [fromIterable](/docs/v3/api/effect/MutableHashSet#fromIterable) | Creates a set from an iterable      | O(n)       |
| constructors | [make](/docs/v3/api/effect/MutableHashSet#make)                 | Creates a set from multiple values  | O(n)       |
| elements     | [has](/docs/v3/api/effect/MutableHashSet#has)                   | Checks if a value exists in the set | O(1) avg   |
| elements     | [add](/docs/v3/api/effect/MutableHashSet#add)                   | Adds a value to the set             | O(1) avg   |
| elements     | [remove](/docs/v3/api/effect/MutableHashSet#remove)             | Removes a value from the set        | O(1) avg   |
| getters      | [size](/docs/v3/api/effect/MutableHashSet#size)                 | Gets the number of elements         | O(1)       |
| mutations    | [clear](/docs/v3/api/effect/MutableHashSet#clear)               | Removes all values from the set     | O(1)       |

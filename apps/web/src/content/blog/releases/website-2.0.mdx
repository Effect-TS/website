...
import twoslash from "./website-2.0/shiki-twoslash.gif"
import twoslashPoster from "./website-2.0/shiki-twoslash-poster.png"
...
- **Better Support for Shiki Twoslash in Code Snippets**
  ...
  <AnimatedFigure
    src={twoslash}
    poster={twoslashPoster}
    label="Twoslash type information"
    description="Twoslash displays type information and error hints alongside the code example."
  />

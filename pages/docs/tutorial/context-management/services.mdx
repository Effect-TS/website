...
```ts filename="service.ts" file=<rootDir>/src/tutorial/context-management/services/service.ts
...
```ts file=<rootDir>/src/tutorial/context-management/services/program-pipe.ts#L1-L8
...
We then use the `Effect.log` utility to log the generated random number.

</Tab>
<Tab>

```ts file=<rootDir>/src/tutorial/context-management/services/program-gen.ts
...
```ts file=<rootDir>/src/tutorial/context-management/services/program-pipe.ts#L10-
...
```ts file=<rootDir>/src/tutorial/context-management/services/serviceOption-pipe.ts#L1-L15
...
```ts file=<rootDir>/src/tutorial/context-management/services/serviceOption-gen.ts
...
```ts file=<rootDir>/src/tutorial/context-management/services/serviceOption-pipe.ts#L17-
...
```ts file=<rootDir>/src/tutorial/context-management/services/multiple-pipe.ts#L1-L22
...
```ts file=<rootDir>/src/tutorial/context-management/services/multiple-gen.ts
...
```ts file=<rootDir>/src/tutorial/context-management/services/multiple-pipe.ts#L24-L37
...
```ts file=<rootDir>/src/tutorial/context-management/services/multiple-pipe.ts#L39-L48

```

and then provide the entire context using the `provideContext` function:

```ts file=<rootDir>/src/tutorial/context-management/services/multiple-pipe.ts#L50-

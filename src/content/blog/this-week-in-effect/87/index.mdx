...
- [effect-notion](https://github.com/PaulJPhilp/effect-notion) v1.0.0 release – a lightweight, production-ready server that acts as a secure proxy for the Notion API, built with Effect. Project by [Paul Philp](https://github.com/PaulJPhilp).

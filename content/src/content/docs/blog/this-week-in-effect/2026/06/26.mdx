...
excerpt: "Two upcoming Effect Miami 🇺🇸 meetups! Stop agent slop with Effect, by Mattia Manzati, Effect Milan 🇮🇹. v4 Beta: adaptive rate limiter, Schema performance, and more."
date: 2026-06-26
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- [Effect Miami Hack Night #1.5](https://luma.com/39g19zzf) is happening on June 30 at Wynwood -- organized by [Ariel Azoulay](https://x.com/ariazou) and [hello_miami](https://x.com/joinhello_miami).

  <Tweet id="2068033044636696790" />

&nbsp;

- [Effect Miami #2](https://luma.com/ly80tuif) is scheduled on July 14, with [David Khourshid](https://x.com/DavidKPiano) joining as main speaker.
...
- Our main marketing driver: [Effect Merch](https://effect.website/merch)!

  <Tweet id="2069870813487214698" />
...
- [Building inkpipe](https://www.thomasdeconinck.fr/blog/2026-06-25-effect-ts-inkpipe) - by Thomas Deconinck.

&nbsp;

- [Arc Work](https://github.com/timhanlon/arcwork) - by Tim Hanlon.
...
- [Rivet](https://rivet.dev/) at Effect Office Hours 34 🔥, with Nathan Flurry and Igor Gassman.

...
```ts file=<rootDir>/src/tutorial/error-management/unexpected-errors/catchAllDefect.ts
...
```ts file=<rootDir>/src/tutorial/error-management/unexpected-errors/catchSomeDefect.ts

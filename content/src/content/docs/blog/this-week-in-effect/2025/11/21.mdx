...
excerpt: Effect New York Meetup roundup. Maybe I Was Wrong About Effect by Ben Davis. Effect Office Hours 9.
date: 2025-11-21
authors:
  - davide_scognamiglio
  - mirela_prifti
...
### Effect Experimental
- [Fix partial window calulation for fixed window rate limiter](https://github.com/Effect-TS/effect/pull/5761) (Bug Fix)
...
- Our New York meetup on Wednesday was a great experience. Big thanks to Warp for welcoming us into their space. Really appreciate everyone who came out and hung out with us.
   <Tweet id="1991525351256912344" />

&nbsp;

- **Maybe I Was Wrong About Effect... (is it really worth it?)** by [Ben Davis](https://www.youtube.com/@bmdavis419).
  <YouTube
...
- [effect-env](https://github.com/PaulJPhilp/effect-env) by [Paul Philp](https://github.com/PaulJPhilp) – a TypeScript library for managing environment variables with type safety, schema validation, and security features, built with Effect, has been updated to the 0.4.1 version!

&nbsp;

- [effect-decorate](https://marketplace.visualstudio.com/items?itemName=DearHumanDev.effect-decorate) - a decorative-only VScode extension that helps reducing Effect code's verbosity has been published. Project by Enrico Polansky.
...
## Effect Content Update
 ...
 - The ninth episode of **Effect Office Hours** went live on Wednesday! We will publish an edited version on our YouTube channel soon. In the meantime, you can watch the [livestream on X(Twitter)](https://x.com/EffectTS_/status/1991159651728232728)

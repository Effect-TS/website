...
In the Effect module, similar to other modules like [Option](/docs/v3/api/effect/Option#match) and [Exit](/docs/v3/data-types/exit/#pattern-matching), we have a `Effect.match` function that allows us to handle different cases simultaneously.

...
| ----------- | --------------------- | --------------------------------------------------------------------------- |
| HTTP routes | HTTP boundary         | Run Place order and translate known outcomes into HTTP results              |
| Place order | Application operation | Decide which payment failures may be retried                                |

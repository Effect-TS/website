...
<Aside type="note" title="Optional Feature">
  ...
  Pipelines](/docs/v3/getting-started/building-pipelines/) in Effect.
</Aside>
...
If you don't want to stop on an error, you can use the `Effect.either` method to encapsulate the error in the [Either](/docs/v3/data-types/either/) data type: see the [examples of managing expected errors](/docs/v3/error-management/expected-errors/#either).
...
<Aside type="note" title="Further Learning">
  ...
  Management](/docs/v3/error-management/two-error-types/) section.
</Aside>

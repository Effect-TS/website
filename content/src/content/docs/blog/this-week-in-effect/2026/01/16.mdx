...
excerpt: 6k Discord Members. Cache | Effect in 5(ish) by Lucas Barake. Effect Office Hours and ChEffect coding sessions.
date: 2026-01-16
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- We're excited to share another community milestone: the [Effect Discord](https://discord.gg/effect-ts) reached 6k+ members!🚀
...
- [`distilled-cloudflare`](https://github.com/alchemy-run/distilled-cloudflare) - A fully typed Cloudflare SDK for Effect, generated from the Cloudflare OpenAPI specification. Provides Effect-native bindings for R2, KV, Workers, Queues, Workflows, and DNS management. Project by [alchemy-run](https://github.com/alchemy-run).

&nbsp;

- [`effer`](https://github.com/lself1022/effer) - An Effect-native UI library built on Lit-HTML for building reactive user interfaces with functional programming patterns. Project by [lself1022](https://github.com/lself1022).

...
Effect 3.1.0 has been released! This release includes a number of new features and improvements, as well as some breaking changes. Here's a summary of what's new:
...
- `Http.multipart.filesSchema` has been renamed to `Http.multipart.FileSchema`

...
const request: Effect.Effect<string, NetworkError | ValidationError> = Effect.fail(
...
const task: Effect.Effect<string, NetworkError | ValidationError> = Effect.fail(new NetworkError())

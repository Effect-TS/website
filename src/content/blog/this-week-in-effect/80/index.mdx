...
excerpt: 11k ⭐️ on GitHub! Building ChEffect (Part 2) & API Provider Integration for Google (PART 3). Leap now supports Effect.
date: 2025-08-22
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- [Chore(test): remove assertType](https://github.com/Effect-TS/effect/pull/5420) (Optimization)
- [Backport formatUnknown from v4](https://github.com/Effect-TS/effect/pull/5422) (Feature)
...
- Behind the scenes of the Glide AI agent, leveraging Effect and AI SDK, by David Siegel, CEO of [Glide](https://www.glideapps.com).
  <Tweet id="1958259779572482341" />

&nbsp;

- [DynamicFlow](https://github.com/jambudipa/dynamic-flow), an Effect-based framework that generates complete LLM execution graphs at runtime, by jambudipa.

&nbsp;

- [Injectio](https://github.com/nemmtor/injectio?tab=readme-ov-file) – an Effect package that transforms React rendering into effects, by nemmtor.

&nbsp;

- Leap now supports Effect!
  <Tweet id="1953398923667603793" />

&nbsp;

- The Polar team has officially started using Effect!
  <Tweet id="1957717808848019720" />
...
**ChEffect - A Local-First Meal Planning App written w/ Effect & LiveStore (PART 2)** & **Building an Effect API Provider Integration for Google (PART 3)** are now on our YouTube Channel.
...
<YouTube
  id="https://www.youtube.com/embed/RXB0FXNIjFg?si=xKcOSF1njNu-f0Mu"
  title="Building an Effect API Provider Integration for Google (PART 3)"
/>

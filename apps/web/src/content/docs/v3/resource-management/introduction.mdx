...
`Effect.onExit` allows you to run a cleanup effect after the main effect completes, receiving an [Exit](/docs/v3/data-types/exit/) value that describes the outcome.

...
excerpt: Cause & Effect 7 with Adam Rankin and Warp. Effect Office Hours 10. New ChEffect episode.
date: 2025-12-19
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- Kit Langton has started sending out invitations to users on the [Effect Institute](https://www.effect.institute/chapters) waitlist. If you haven’t signed up yet, make sure to do so to get access to Kit’s Effect tutorial series.
...
- Special thanks to [Sam Goodwin](https://x.com/samgoodwin89) for highlighting how Effect makes it incredibly easy to test failure and recovery scenarios.

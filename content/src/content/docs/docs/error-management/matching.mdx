...
In the Effect module, similar to other modules like [Option](/docs/data-types/option/#matching) and [Exit](/docs/data-types/exit/#matching), we have a `match` function that allows us to handle different cases simultaneously.

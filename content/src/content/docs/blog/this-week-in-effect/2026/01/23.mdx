---
pagefind: false
title: This Week in Effect - 2026-01-23
excerpt: Effect made me rethink all my server side Typescript solutions by Backpine labs. RcMap | Effect in 5(ish) by Lucas Barake. Effect Office Hours and Lalph coding sessions.
date: 2026-01-23
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- The [Effect community](https://discord.gg/effect-ts) on Discord reached 6070+ members!
...
- **Effect made me rethink all my server side Typescript solutions** by [backpine labs](https://www.youtube.com/@lucas-barake).

<YouTube
  id="https://www.youtube.com/embed/85yz418Tris?si=8Wm6269_sjUQDclE"
  title="Effect made me rethink all my server side Typescript solutions"
/>

&nbsp;

- **RcMap | Effect in 5(ish)** by [Lucas Barake](https://www.youtube.com/@lucas-barake).
...
- **Effect Office Hours 13** went live on Wednesday! We will publish an edited version on our YouTube channel soon. In the meantime, you can watch the [livestream on X(Twitter)](https://x.com/EffectTS_/status/2013990786116046954).

- Max joined Tim to continue their work on *Lalph - An AI Agent Orchestrator*.
  <Tweet id="2014102979897598233" />

- **Office Hours 12: Library Design, Error Modeling, Schema vs runtime errors, Effect 4.0 APIs** and **Hacking on Lalph - A Ralph-inspired AI agent orchestrator powered by Effect** are now on our YouTube Channel.

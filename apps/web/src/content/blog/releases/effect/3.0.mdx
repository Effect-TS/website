...
![JavaScript pain points by user count: code architecture 14,220; managing dependencies 13,589; state management 12,529; data management 8,790; debugging 8,788; finding packages 5,956; writing modules 4,943; async code 4,475.](https://i.imgur.com/7MSgUnL.png)
...
![Features users say JavaScript is missing, by user count: static typing 15,361; standard library 12,928; better data management 10,902; immutable data structures 8,243; Observable 6,515; pipe operator 5,860; decorators 5,222; pattern matching 4,872.](https://i.imgur.com/uqJutUl.png)

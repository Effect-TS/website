...
export default function Blog() {
  return (
    <main className="docs-container relative w-full max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 pt-16">
      <h2 className="font-display text-2xl sm:text-3xl lg:text-4xl text-white">{content.heading}</h2>
          ...
          <Link href={urlPath} key={index} className="bg-gradient-to-br from-zinc-800 to-zinc-900 rounded-2xl p-6">
            ...
            <div className="flex pl-2 items-center mt-4">
              {authors.map(({ avatar, name }, index) => (
                <div key={index} className="h-6 w-6 rounded-full relative overflow-hidden -ml-2 border border-white shadow">

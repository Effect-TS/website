...
If you don't want to stop on an error, you can use the `Effect.result` method to encapsulate the error in the [Result](/docs/data-types/result/) data type: see the [examples of managing expected errors](/docs/error-management/expected-errors/#either).

...
excerpt: Learning Effect with teej dv & Kit Langton. Error Handling & Effectful Programming in TypeScript w/ Effect by Mattia Manzati. Effect Office Hours 5 & Rebuilding Contentlayer with Effect coding sessions.
date: 2025-10-24
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- [Make sure AsEffect is computed](https://github.com/Effect-TS/effect/pull/5628) (Bug Fix)

### Effect AI

- [Ensure model field accepts a string in Anthropic schemas](https://github.com/Effect-TS/effect/pull/5644) (Bug Fix)

&nbsp;

## Community Highlights

- [teej dv](https://x.com/teej_dv) was live with [Kit Langton](https://x.com/kitlangton) for an Effect learning session. You can't afford not to use Effect at this point.
  <Tweet id="1981345962715910620" />

&nbsp;

- [effect-env](https://github.com/PaulJPhilp/effect-env) – a TypeScript library for managing environment variables with type safety, schema validation, and security features, built with Effect. Project by [Paul Philp](https://github.com/PaulJPhilp).

&nbsp;

- [Alette Signal](https://alette-os.com/) Beta release. A frontend data fetching library built with Effect.

&nbsp;

- [@effectify/node-better-auth](https://github.com/devx-op/effectify/tree/master/packages/node/better-auth),an integration of [better-auth](https://github.com/better-auth/better-auth) with Effect for Node.js applications has been released.
...
- The first [Effect Meetup in Nice](https://www.linkedin.com/posts/hugo-mufraggi-5b081b134_english-below-hier-jai-eu-le-plaisir-activity-7387417208991436800-frW1) happened on October 23rd, thanks to Hugo Muffraggi, who also shared that the next one is planned for early next year.

&nbsp;

## Effect Content Update

- The fifth episode of **Effect Office Hours** aired on Wednesday! We will publish an edited version on our YouTube channel soon. In the meantime, you can watch the livestream on X(Twitter) below.
  <Tweet id="1981072917841744274" />

&nbsp;

- The first talk from the Effect Milan Meetup 2025, **Error Handling & Effectful Programming in TypeScript w/ Effect** by Mattia Manzati, is now on YouTube.
  <YouTube
    id="https://www.youtube.com/embed/V_XfZbxabI8?si=bnueNIzIBlolSQ1p"
    title="Error Handling & Effectful Programming in TypeScript w/ Effect | Mattia Manzati | Effect Milan 2025"
  />
...
<YouTube
  id="https://www.youtube.com/embed/ev5hNgGZz6o?si=HbOcvDad5N2GLCQS"
  title="🔥 Effect Office Hours 4: Effect Atom, Effect API, Tracing & Telemetry, File System Abstractions..."
/>

&nbsp;

<YouTube
  id="https://www.youtube.com/embed/_vU9i_aRcxs?si=6AGQ_9vXskg0GGkS"
  title="Rebuilding Contentlayer w/Effect (Part 19)"
/>

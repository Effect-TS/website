...
excerpt: "Maxwell kicks off a new Module of the Week series, starting with PersistedQueue. Triplex brings an Effect-native fact database to the ecosystem, and effect-viz v3.0.0 adds a stepper to pause and walk through Effect's scheduler one decision at a time."
date: 2026-09-18
authors:
  - davide_scognamiglio
  - mirela_prifti
...
Maxwell started a new [blog series](https://effect.website/blog/module-of-the-week) to help the community discover the lesser-known parts of Effect, one module at a time. Read about [PersistedQueue](https://effect.website/blog/module-of-the-week/persisted-queue) the first featured **Module of the Week**.

<Tweet id="2100202848222871562" />

<Tweet id="2100261137296023614" />
...
- The 2-day passes for Effect Days are still available but they're going away fast! The conference is scheduled on December 9–11, 2026 in Livorno, Italy.
...
- Thank you to all our Effecters attending [Effect Warsaw](https://luma.com/29fn6spj) this week!
...
- [Triplex](https://github.com/bjacobso/triplex) - an Effect-native fact database that keeps a single identity model, clock, and provenance chain for what is true, what was true, and which versioned rules governed each write, so applications can explain themselves. By Ben Jacobson.

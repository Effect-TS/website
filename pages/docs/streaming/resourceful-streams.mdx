...
```ts file=<rootDir>/src/streaming/resourceful-streams/acquireRelease.ts
...
```ts file=<rootDir>/src/streaming/resourceful-streams/finalizer.ts
...
```ts file=<rootDir>/src/streaming/resourceful-streams/ensuring.ts

...
| ------------ | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| `map`        | `Effect<R, E, A>`, <br/> `A => B`                         | `Effect<R, E, B>`                                                                                                              |
| `flatMap`    | `Effect<R1, E1, A>`, <br/> `A => Effect<R2, E2, B>`       | `Effect<R1 \| R2, E1 \| E2, B>`                                                                                                |
| `all`        | `Effect<R1, E1, A>`, <br/> `Effect<R2, E2, B>`, <br/> ... | `Effect<` <br/>&nbsp;&nbsp; `R1 \| R2 \| ...,` <br/>&nbsp;&nbsp; `E1 \| E2 \| ...,` <br/>&nbsp;&nbsp; ` [A, B, ...]` <br/> `>` |

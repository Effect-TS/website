...
- **Office Hours 12: Library Design, Error Modeling, Schema vs runtime errors, Effect 4.0 APIs** and **ChEffect - Part 13: A Local-First Meal Planning App written with Effect & LiveStore** are now on our YouTube Channel.

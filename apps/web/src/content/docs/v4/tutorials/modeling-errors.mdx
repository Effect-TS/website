...
Here are the original error definitions:
...
Replace only the error definitions with `Data.TaggedError`:
...
Their unique identifiers keep the three error types distinct in the union.

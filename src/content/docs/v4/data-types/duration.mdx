...
Duration.fromInputUnsafe(10n) // same as Duration.nanos(10)
Duration.fromInputUnsafe(100) // same as Duration.millis(100)
Duration.fromInputUnsafe(Infinity) // same as Duration.infinity

Duration.fromInputUnsafe("10 nanos") // same as Duration.nanos(10)
Duration.fromInputUnsafe("20 micros") // same as Duration.micros(20)
Duration.fromInputUnsafe("100 millis") // same as Duration.millis(100)
Duration.fromInputUnsafe("2 seconds") // same as Duration.seconds(2)
Duration.fromInputUnsafe("5 minutes") // same as Duration.minutes(5)
Duration.fromInputUnsafe("7 hours") // same as Duration.hours(7)
Duration.fromInputUnsafe("3 weeks") // same as Duration.weeks(3)
```

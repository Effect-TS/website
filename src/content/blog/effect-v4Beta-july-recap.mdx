...
The [v4 API documentation](https://github.com/Effect-TS/effect/pull/6739) was deployed to Cloudflare Pages, making the full Effect v4 API reference publicly accessible for the first time.

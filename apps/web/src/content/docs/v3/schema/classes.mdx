...
- **Value Hashing and Equality**: Utilize the built-in capability for checking value equality and applying hashing (thanks to `Class` implementing [Data.Class](/docs/v3/data-types/data/#class)).
...
Instances of classes created with `Schema.Class` support the [Equal](/docs/v3/trait/equal/) trait through their integration with [Data.Class](/docs/v3/data-types/data/#class). This enables straightforward value comparisons, even across different instances.
...
You can also create classes that extend [TaggedClass](/docs/v3/data-types/data/#taggedclass) and [TaggedError](/docs/v3/data-types/data/#taggederror) from the `effect/Data` module.

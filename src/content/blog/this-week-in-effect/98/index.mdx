...
excerpt: 🎄 Xmas gift from the terminal.shop for the Effect community! effect-distributed-lock by Ethan Niser.
date: 2025-12-27
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- [Regenerate Open Router Schemas](https://github.com/Effect-TS/effect/pull/5928) (Bug Fix)
- [Fix accumulation of response parts in Chat.streamText](https://github.com/Effect-TS/effect/pull/5931) (Bug Fix)

&nbsp;

## Happy Holidays from the Effect Team

As the year wraps up, a big thank you to everyone in the Effect community.

Whether you’ve been building in production, experimenting, or helping others on Discord, we’re grateful to have you with us.

Wishing you a restful holiday season and a great start to 2026. Excited for what’s ahead.
...
- Many thanks to teej & ThePrimeagen from the [terminal](https://www.terminal.shop/) for choosing to donate to Effect during their last Xmas Stream.
  <Tweet id="2003510051231965459" />

&nbsp;

- [`effect-distributed-lock`](https://github.com/ethanniser/effect-distributed-lock) a distributed semaphore library for Effect with pluggable backends. Project by Ethan Niser.
  <Tweet id="2003264271850029334" />

&nbsp;

- [The Effect Patterns Hub](https://github.com/PaulJPhilp/EffectPatterns) has been updated to v1.0.0. Project by [Paul Philp](https://github.com/PaulJPhilp)

&nbsp;

- More improvements to `create-tui` using Effect, by Matt Simpson.
  <Tweet id="2002388136433684924" />

...
```ts filename="Counter.ts" file=<rootDir>/src/guide/state-management/Counter.ts
...
```ts file=<rootDir>/src/guide/state-management/example-1-gen.ts
...
```ts file=<rootDir>/src/guide/state-management/example-1-pipe.ts
...
```ts file=<rootDir>/src/guide/state-management/example-1-concurrent-gen.ts
...
```ts file=<rootDir>/src/guide/state-management/example-1-concurrent-pipe.ts
...
```ts file=<rootDir>/src/guide/state-management/ref-as-service-gen.ts
...
```ts file=<rootDir>/src/guide/state-management/ref-as-service-pipe.ts
...
```ts filename="ReadLine.ts" file=<rootDir>/src/guide/state-management/ReadLine.ts
...
```ts file=<rootDir>/src/guide/state-management/example-2-gen.ts
...
```ts file=<rootDir>/src/guide/state-management/example-2-pipe.ts
...
```ts file=<rootDir>/src/guide/state-management/example-2-concurrent-gen.ts
...
```ts file=<rootDir>/src/guide/state-management/example-2-concurrent-pipe.ts

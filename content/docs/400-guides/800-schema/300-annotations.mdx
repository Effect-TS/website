...
| `jsonSchema`       | Specifies annotations that affect the generation of [JSON Schema](json-schema) documents, customizing how schemas are represented.                                                                                                                            |
| `arbitrary`        | Configures settings for generating [Arbitrary](arbitrary) test data.                                                                                                                                                                                          |
| `pretty`           | Configures settings for generating [Pretty](pretty) output.                                                                                                                                                                                                   |
| `equivalence`      | Configures settings for evaluating data [Equivalence](equivalence).                                                                                                                                                                                           |
